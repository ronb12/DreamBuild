import{r as p,a as ua,b as ma,R as De,g as pa}from"./react-vendor-DWvC8KHc.js";import{_ as ha,C as fa,r as pn,S as ga,F as xa,g as fs,a as Tr,b as ba,c as ya,d as va,i as vr,e as $s,f as Bs,o as Us,h as dr,j as V,s as wa,G as hn,k as fn,l as be,m as ja,n as Na,u as er,p as Ot,q as ue,t as we,w as me,v as It,x as $e,y as Yr,z as ur,A as Sa,B as Mt}from"./firebase-_l3dWQPc.js";import{_ as rt}from"./monaco-editor-BWpThiUx.js";import{S as vt,R as Ee,C as X,D as yt,U as gs,M as Ca,a as ka,b as xs,L as gn,X as Ta,c as Da,G as pe,T as Hs,d as wr,e as zs,m as O,f as yo,Z as wt,F as Fe,P as jt,g as gt,h as vo,i as We,j as Ea,k as wo,A as He,l as zt,n as Nt,o as bs,p as jo,q as Dr,E as Gt,r as Aa,s as Pa,B as Xr,t as jr,u as Ra,v as Oa,w as Ie,x as Ve,y as Er,z as Ae,H as Gs,I as Ia,J as it,K as St,N as ys,O as Me,Q as No,V as Ma,W as So,Y as Fa,_ as Co,$ as ko,a0 as La,a1 as qs,a2 as _a,a3 as $a,a4 as Ba,a5 as Ar,a6 as xt,a7 as Ua,a8 as To,a9 as Ha,aa as za,ab as Ga,ac as mr,ad as qa,ae as Qr,af as xn,ag as vs,ah as ws,ai as js,aj as Wa,ak as Va,al as Ja}from"./ui-vendor-6CVz1JuZ.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))n(o);new MutationObserver(o=>{for(const i of o)if(i.type==="childList")for(const a of i.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&n(a)}).observe(document,{childList:!0,subtree:!0});function s(o){const i={};return o.integrity&&(i.integrity=o.integrity),o.referrerPolicy&&(i.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?i.credentials="include":o.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function n(o){if(o.ep)return;o.ep=!0;const i=s(o);fetch(o.href,i)}})();var Do={exports:{}},Pr={};/**
 * @license React
 ...
 */var Ka=p,Ya=Symbol.for("react.element"),Xa=Symbol.for("react.fragment"),Qa=Object.prototype.hasOwnProperty,Za=Ka.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,el={key:!0,ref:!0,__self:!0,__source:!0};function Eo(r,e,s){var n,o={},i=null,a=null;s!==void 0&&(i=""+s),e.key!==void 0&&(i=""+e.key),e.ref!==void 0&&(a=e.ref);for(n in e)Qa.call(e,n)&&!el.hasOwnProperty(n)&&(o[n]=e[n]);if(r&&r.defaultProps)for(n in e=r.defaultProps,e)o[n]===void 0&&(o[n]=e[n]);return{$$typeof:Ya,type:r,key:i,ref:a,props:o,_owner:Za.current}}Pr.Fragment=Xa;Pr.jsx=Eo;Pr.jsxs=Eo;Do.exports=Pr;var t=Do.exports,Ao,bn=ua;Ao=bn.createRoot,bn.hydrateRoot;/**
 ...
 *
 * @license MIT
 */function Cs(){return Cs=Object.assign?Object.assign.bind():function(r){for(var e=1;e<arguments.length;e++){var s=arguments[e];for(var n in s)Object.prototype.hasOwnProperty.call(s,n)&&(r[n]=s[n])}return r},Cs.apply(this,arguments)}function Vl(r,e){if(r==null)return{};var s={},n=Object.keys(r),o,i;for(i=0;i<n.length;i++)o=n[i],!(e.indexOf(o)>=0)&&(s[o]=r[o]);return s}function Jl(r){return!!(r.metaKey||r.altKey||r.ctrlKey||r.shiftKey)}function Kl(r,e){return r.button===0&&(!e||e==="_self")&&!Jl(r)}const Yl=["onClick","relative","reloadDocument","replace","state","target","to","preventScrollReset","viewTransition"],Xl="6";try{window.__reactRouterVersion=Xl}catch{}const Ql="startTransition",Sn=ma[Ql];function Zl(r){let{basename:e,children:s,future:n,window:o}=r,i=p.useRef();i.current==null&&(i.current=tl({window:o,v5Compat:!0}));let a=i.current,[l,d]=p.useState({action:a.action,location:a.location}),{v7_startTransition:c}=n||{},u=p.useCallback(m=>{c&&Sn?Sn(()=>d(m)):d(m)},[d,c]);return p.useLayoutEffect(()=>a.listen(u),[a,u]),p.useEffect(()=>zl(n),[n]),p.createElement(ql,{basename:e,children:s,location:l.location,navigationType:l.action,navigator:a,future:n})}const ec=typeof window<"u"&&typeof window.document<"u"&&typeof window.document.createElement<"u",tc=/^(?:[a-z][a-z0-9+.-]*:|\/\/)/i,ae=p.forwardRef(function(e,s){let{onClick:n,relative:o,reloadDocument:i,replace:a,state:l,target:d,to:c,preventScrollReset:u,viewTransition:m}=e,x=Vl(e,Yl),{basename:y}=p.useContext(Je),g,f=!1;if(typeof c=="string"&&tc.test(c)&&(g=c,ec))try{let j=new URL(window.location.href),w=c.startsWith("//")?new URL(j.protocol+c):new URL(c),v=Ws(w.pathname,y);w.origin===j.origin&&v!=null?c=v+w.search+w.hash:f=!0}catch{}let h=Dl(c,{relative:o}),S=rc(c,{replace:a,state:l,target:d,preventScrollReset:u,relative:o,viewTransition:m});function b(j){n&&n(j),j.defaultPrevented||S(j)}return p.createElement("a",Cs({},x,{href:g||h,onClick:f||i?n:b,ref:s,target:d}))});var Cn;(function(r){r.UseScrollRestoration="useScrollRestoration",r.UseSubmit="useSubmit",r.UseSubmitFetcher="useSubmitFetcher",r.UseFetcher="useFetcher",r.useViewTransitionState="useViewTransitionState"})(Cn||(Cn={}));var kn;(function(r){r.UseFetcher="useFetcher",r.UseFetchers="useFetchers",r.UseScrollRestoration="useScrollRestoration"})(kn||(kn={}));function rc(r,e){let{target:s,replace:n,state:o,preventScrollReset:i,relative:a,viewTransition:l}=e===void 0?{}:e,d=Or(),c=Ye(),u=Lo(r,{relative:a});return p.useCallback(m=>{if(Kl(m,s)){m.preventDefault();let x=n!==void 0?n:Nr(c)===Nr(u);d(r,{replace:x,state:o,preventScrollReset:i,relative:a,viewTransition:l})}},[c,d,u,n,o,s,r,i,a,l])}let sc={data:""},nc=r=>typeof window=="object"?((r?r.querySelector("#_goober"):window._goober)||Object.assign((r||document.head).appendChild(document.createElement("style")),{innerHTML:" ",id:"_goober"})).firstChild:r||sc,oc=/(?:([\u0080-\uFFFF\w-%@]+) *:? *([^{;]+?);|([^;}{]*?) *{)|(}\s*)/g,ic=/\/\*[^]*?\*\/|  +/g,Tn=/\n+/g,Be=(r,e)=>{let s="",n="",o="";for(let i in r){let a=r[i];i[0]=="@"?i[1]=="i"?s=i+" "+a+";":n+=i[1]=="f"?Be(a,i):i+"{"+Be(a,i[1]=="k"?"":e)+"}":typeof a=="object"?n+=Be(a,e?e.replace(/([^,])+/g,l=>i.replace(/([^,]*:\S+\([^)]*\))|([^,])+/g,d=>/&/.test(d)?d.replace(/&/g,l):l?l+" "+d:d)):i):a!=null&&(i=/^--/.test(i)?i:i.replace(/[A-Z]/g,"-$&").toLowerCase(),o+=Be.p?Be.p(i,a):i+":"+a+";")}return s+(e&&o?e+"{"+o+"}":o)+n},Re={},Uo=r=>{if(typeof r=="object"){let e="";for(let s in r)e+=s+Uo(r[s]);return e}return r},ac=(r,e,s,n,o)=>{let i=Uo(r),a=Re[i]||(Re[i]=(d=>{let c=0,u=11;for(;c<d.length;)u=101*u+d.charCodeAt(c++)>>>0;return"go"+u})(i));if(!Re[a]){let d=i!==r?r:(c=>{let u,m,x=[{}];for(;u=oc.exec(c.replace(ic,""));)u[4]?x.shift():u[3]?(m=u[3].replace(Tn," ").trim(),x.unshift(x[0][m]=x[0][m]||{})):x[0][u[1]]=u[2].replace(Tn," ").trim();return x[0]})(r);Re[a]=Be(o?{["@keyframes "+a]:d}:d,s?"":"."+a)}let l=s&&Re.g?Re.g:null;return s&&(Re.g=Re[a]),((d,c,u,m)=>{m?c.data=c.data.replace(m,d):c.data.indexOf(d)===-1&&(c.data=u?d+c.data:c.data+d)})(Re[a],e,n,l),a},lc=(r,e,s)=>r.reduce((n,o,i)=>{let a=e[i];if(a&&a.call){let l=a(s),d=l&&l.props&&l.props.className||/^go/.test(l)&&l;a=d?"."+d:l&&typeof l=="object"?l.props?"":Be(l,""):l===!1?"":l}return n+o+(a??"")},"");function Ir(r){let e=this||{},s=r.call?r(e.p):r;return ac(s.unshift?s.raw?lc(s,[].slice.call(arguments,1),e.p):s.reduce((n,o)=>Object.assign(n,o&&o.call?o(e.p):o),{}):s,nc(e.target),e.g,e.o,e.k)}let Ho,ks,Ts;Ir.bind({g:1});let Le=Ir.bind({k:1});function cc(r,e,s,n){Be.p=e,Ho=r,ks=s,Ts=n}function Xe(r,e){let s=this||{};return function(){let n=arguments;function o(i,a){let l=Object.assign({},i),d=l.className||o.className;s.p=Object.assign({theme:ks&&ks()},l),s.o=/ *go\d+/.test(d),l.className=Ir.apply(s,n)+(d?" "+d:"");let c=r;return r[0]&&(c=l.as||r,delete l.as),Ts&&c[0]&&Ts(l),Ho(c,l)}return o}}var dc=r=>typeof r=="function",Sr=(r,e)=>dc(r)?r(e):r,uc=(()=>{let r=0;return()=>(++r).toString()})(),zo=(()=>{let r;return()=>{if(r===void 0&&typeof window<"u"){let e=matchMedia("(prefers-reduced-motion: reduce)");r=!e||e.matches}return r}})(),mc=20,Ys="default",Go=(r,e)=>{let{toastLimit:s}=r.settings;switch(e.type){case 0:return{...r,toasts:[e.toast,...r.toasts].slice(0,s)};case 1:return{...r,toasts:r.toasts.map(a=>a.id===e.toast.id?{...a,...e.toast}:a)};case 2:let{toast:n}=e;return Go(r,{type:r.toasts.find(a=>a.id===n.id)?1:0,toast:n});case 3:let{toastId:o}=e;return{...r,toasts:r.toasts.map(a=>a.id===o||o===void 0?{...a,dismissed:!0,visible:!1}:a)};case 4:return e.toastId===void 0?{...r,toasts:[]}:{...r,toasts:r.toasts.filter(a=>a.id!==e.toastId)};case 5:return{...r,pausedAt:e.time};case 6:let i=e.time-(r.pausedAt||0);return{...r,pausedAt:void 0,toasts:r.toasts.map(a=>({...a,pauseDuration:a.pauseDuration+i}))}}},pr=[],qo={toasts:[],pausedAt:void 0,settings:{toastLimit:mc}},ke={},Wo=(r,e=Ys)=>{ke[e]=Go(ke[e]||qo,r),pr.forEach(([s,n])=>{s===e&&n(ke[e])})},Vo=r=>Object.keys(ke).forEach(e=>Wo(r,e)),pc=r=>Object.keys(ke).find(e=>ke[e].toasts.some(s=>s.id===r)),Mr=(r=Ys)=>e=>{Wo(e,r)},hc={blank:4e3,error:4e3,success:2e3,loading:1/0,custom:4e3},fc=(r={},e=Ys)=>{let[s,n]=p.useState(ke[e]||qo),o=p.useRef(ke[e]);p.useEffect(()=>(o.current!==ke[e]&&n(ke[e]),pr.push([e,n]),()=>{let a=pr.findIndex(([l])=>l===e);a>-1&&pr.splice(a,1)}),[e]);let i=s.toasts.map(a=>{var l,d,c;return{...r,...r[a.type],...a,removeDelay:a.removeDelay||((l=r[a.type])==null?void 0:l.removeDelay)||(r==null?void 0:r.removeDelay),duration:a.duration||((d=r[a.type])==null?void 0:d.duration)||(r==null?void 0:r.duration)||hc[a.type],style:{...r.style,...(c=r[a.type])==null?void 0:c.style,...a.style}}});return{...s,toasts:i}},gc=(r,e="blank",s)=>({createdAt:Date.now(),visible:!0,dismissed:!1,type:e,ariaProps:{role:"status","aria-live":"polite"},message:r,pauseDuration:0,...s,id:(s==null?void 0:s.id)||uc()}),Jt=r=>(e,s)=>{let n=gc(e,r,s);return Mr(n.toasterId||pc(n.id))({type:2,toast:n}),n.id},Y=(r,e)=>Jt("blank")(r,e);Y.error=Jt("error");Y.success=Jt("success");Y.loading=Jt("loading");Y.custom=Jt("custom");Y.dismiss=(r,e)=>{let s={type:3,toastId:r};e?Mr(e)(s):Vo(s)};Y.dismissAll=r=>Y.dismiss(void 0,r);Y.remove=(r,e)=>{let s={type:4,toastId:r};e?Mr(e)(s):Vo(s)};Y.removeAll=r=>Y.remove(void 0,r);Y.promise=(r,e,s)=>{let n=Y.loading(e.loading,{...s,...s==null?void 0:s.loading});return typeof r=="function"&&(r=r()),r.then(o=>{let i=e.success?Sr(e.success,o):void 0;return i?Y.success(i,{id:n,...s,...s==null?void 0:s.success}):Y.dismiss(n),o}).catch(o=>{let i=e.error?Sr(e.error,o):void 0;i?Y.error(i,{id:n,...s,...s==null?void 0:s.error}):Y.dismiss(n)}),r};var xc=1e3,bc=(r,e="default")=>{let{toasts:s,pausedAt:n}=fc(r,e),o=p.useRef(new Map).current,i=p.useCallback((m,x=xc)=>{if(o.has(m))return;let y=setTimeout(()=>{o.delete(m),a({type:4,toastId:m})},x);o.set(m,y)},[]);p.useEffect(()=>{if(n)return;let m=Date.now(),x=s.map(y=>{if(y.duration===1/0)return;let g=(y.duration||0)+y.pauseDuration-(m-y.createdAt);if(g<0){y.visible&&Y.dismiss(y.id);return}return setTimeout(()=>Y.dismiss(y.id,e),g)});return()=>{x.forEach(y=>y&&clearTimeout(y))}},[s,n,e]);let a=p.useCallback(Mr(e),[e]),l=p.useCallback(()=>{a({type:5,time:Date.now()})},[a]),d=p.useCallback((m,x)=>{a({type:1,toast:{id:m,height:x}})},[a]),c=p.useCallback(()=>{n&&a({type:6,time:Date.now()})},[n,a]),u=p.useCallback((m,x)=>{let{reverseOrder:y=!1,gutter:g=8,defaultPosition:f}=x||{},h=s.filter(j=>(j.position||f)===(m.position||f)&&j.height),S=h.findIndex(j=>j.id===m.id),b=h.filter((j,w)=>w<S&&j.visible).length;return h.filter(j=>j.visible).slice(...y?[b+1]:[0,b]).reduce((j,w)=>j+(w.height||0)+g,0)},[s]);return p.useEffect(()=>{s.forEach(m=>{if(m.dismissed)i(m.id,m.removeDelay);else{let x=o.get(m.id);x&&(clearTimeout(x),o.delete(m.id))}})},[s,i]),{toasts:s,handlers:{updateHeight:d,startPause:l,endPause:c,calculateOffset:u}}},yc=Le`
from {
 ...
 */const Ko="firebasestorage.googleapis.com",Yo="storageBucket",Wc=2*60*1e3,Vc=10*60*1e3;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ye{constructor(e,s){this.bucket=e,this.path_=s}get path(){return this.path_}get isRoot(){return this.path.length===0}fullServerUrl(){const e=encodeURIComponent;return"/b/"+e(this.bucket)+"/o/"+e(this.path)}bucketOnlyServerUrl(){return"/b/"+encodeURIComponent(this.bucket)+"/o"}static makeFromBucketSpec(e,s){let n;try{n=ye.makeFromUrl(e,s)}catch{return new ye(e,"")}if(n.path==="")return n;throw rd(e)}static makeFromUrl(e,s){let n=null;const o="([A-Za-z0-9.\\-_]+)";function i(w){w.path.charAt(w.path.length-1)==="/"&&(w.path_=w.path_.slice(0,-1))}const a="(/(.*))?$",l=new RegExp("^gs://"+o+a,"i"),d={bucket:1,path:3};function c(w){w.path_=decodeURIComponent(w.path)}const u="v[A-Za-z0-9_]+",m=s.replace(/[.]/g,"\\."),x="(/([^?#]*).*)?$",y=new RegExp(`^https?://${m}/${u}/b/${o}/o${x}`,"i"),g={bucket:1,path:3},f=s===Ko?"(?:storage.googleapis.com|storage.cloud.google.com)":s,h="([^?#]*)",S=new RegExp(`^https?://${f}/${o}/${h}`,"i"),j=[{regex:l,indices:d,postModify:i},{regex:y,indices:g,postModify:c},{regex:S,indices:{bucket:1,path:2},postModify:c}];for(let w=0;w<j.length;w++){const v=j[w],D=v.regex.exec(e);if(D){const A=D[v.indices.bucket];let M=D[v.indices.path];M||(M=""),n=new ye(A,M),v.postModify(n);break}}if(n==null)throw td(e);return n}}class ld{constructor(e){this.promise_=Promise.reject(e)}getPromise(){return this.promise_}cancel(e=!1){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function cd(r,e,s){let n=1,o=null,i=null,a=!1,l=0;function d(){return l===2}let c=!1;function u(...h){c||(c=!0,e.apply(null,h))}function m(h){o=setTimeout(()=>{o=null,r(y,d())},h)}function x(){i&&clearTimeout(i)}function y(h,...S){if(c){x();return}if(h){x(),u.call(null,h,...S);return}if(d()||a){x(),u.call(null,h,...S);return}n<64&&(n*=2);let j;l===1?(l=2,j=0):j=(n+Math.random())*1e3,m(j)}let g=!1;function f(h){g||(g=!0,x(),!c&&(o!==null?(h||(l=2),clearTimeout(o),m(0)):h||(l=1)))}return m(0),i=setTimeout(()=>{a=!0,f(!0)},s),f}function dd(r){r(!1)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ud(r){return r!==void 0}function md(r){return typeof r=="object"&&!Array.isArray(r)}function Qs(r){return typeof r=="string"||r instanceof String}function En(r){return Zs()&&r instanceof Blob}function Zs(){return typeof Blob<"u"}function An(r,e,s,n){if(n<e)throw Ds(`Invalid value for '${r}'. Expected ${e} or greater.`);if(n>s)throw Ds(`Invalid value for '${r}'. Expected ${s} or less.`)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Te={RAW:"raw",BASE64:"base64",BASE64URL:"base64url",DATA_URL:"data_url"};class ts{constructor(e,s){this.data=e,this.contentType=s||null}}function Sd(r,e){switch(r){case Te.RAW:return new ts(Zo(e));case Te.BASE64:case Te.BASE64URL:return new ts(ei(r,e));case Te.DATA_URL:return new ts(kd(e),Td(e))}throw Xs()}function Zo(r){const e=[];for(let s=0;s<r.length;s++){let n=r.charCodeAt(s);if(n<=127)e.push(n);else if(n<=2047)e.push(192|n>>6,128|n&63);else if((n&64512)===55296)if(!(s<r.length-1&&(r.charCodeAt(s+1)&64512)===56320))e.push(239,191,189);else{const i=n,a=r.charCodeAt(++s);n=65536|(i&1023)<<10|a&1023,e.push(240|n>>18,128|n>>12&63,128|n>>6&63,128|n&63)}else(n&64512)===56320?e.push(239,191,189):e.push(224|n>>12,128|n>>6&63,128|n&63)}return new Uint8Array(e)}function Cd(r){let e;try{e=decodeURIComponent(r)}catch{throw Bt(Te.DATA_URL,"Malformed data URL.")}return Zo(e)}function ei(r,e){switch(r){case Te.BASE64:{const o=e.indexOf("-")!==-1,i=e.indexOf("_")!==-1;if(o||i)throw Bt(r,"Invalid character '"+(o?"-":"_")+"' found: is it base64url encoded?");break}case Te.BASE64URL:{const o=e.indexOf("+")!==-1,i=e.indexOf("/")!==-1;if(o||i)throw Bt(r,"Invalid character '"+(o?"+":"/")+"' found: is it base64 encoded?");e=e.replace(/-/g,"+").replace(/_/g,"/");break}}let s;try{s=Nd(e)}catch(o){throw o.message.includes("polyfill")?o:Bt(r,"Invalid character found")}const n=new Uint8Array(s.length);for(let o=0;o<s.length;o++)n[o]=s.charCodeAt(o);return n}class ti{constructor(e){this.base64=!1,this.contentType=null;const s=e.match(/^data:([^,]+)?,/);if(s===null)throw Bt(Te.DATA_URL,"Must be formatted 'data:[<mediatype>][;base64],<data>");const n=s[1]||null;n!=null&&(this.base64=Dd(n,";base64"),this.contentType=this.base64?n.substring(0,n.length-7):n),this.rest=e.substring(e.indexOf(",")+1)}}function kd(r){const e=new ti(r);return e.base64?ei(Te.BASE64,e.rest):Cd(e.rest)}function Td(r){return new ti(r).contentType}function Dd(r,e){return r.length>=e.length?r.substring(r.length-e.length)===e:!1}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ue{constructor(e,s){let n=0,o="";En(e)?(this.data_=e,n=e.size,o=e.type):e instanceof ArrayBuffer?(s?this.data_=new Uint8Array(e):(this.data_=new Uint8Array(e.byteLength),this.data_.set(new Uint8Array(e))),n=this.data_.length):e instanceof Uint8Array&&(s?this.data_=e:(this.data_=new Uint8Array(e.length),this.data_.set(e)),n=e.length),this.size_=n,this.type_=o}size(){return this.size_}type(){return this.type_}slice(e,s){if(En(this.data_)){const n=this.data_,o=jd(n,e,s);return o===null?null:new Ue(o)}else{const n=new Uint8Array(this.data_.buffer,e,s-e);return new Ue(n,!0)}}static getBlob(...e){if(Zs()){const s=e.map(n=>n instanceof Ue?n.data_:n);return new Ue(wd.apply(null,s))}else{const s=e.map(a=>Qs(a)?Sd(Te.RAW,a).data:a.data_);let n=0;s.forEach(a=>{n+=a.byteLength});const o=new Uint8Array(n);let i=0;return s.forEach(a=>{for(let l=0;l<a.length;l++)o[i++]=a[l]}),new Ue(o,!0)}}uploadData(){return this.data_}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ri(r){let e;try{e=JSON.parse(r)}catch{return null}return md(e)?e:null}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ed(r){if(r.length===0)return null;const e=r.lastIndexOf("/");return e===-1?"":r.slice(0,e)}function Ad(r,e){const s=e.split("/").filter(n=>n.length>0).join("/");return r.length===0?s:r+"/"+s}function si(r){const e=r.lastIndexOf("/",r.length-2);return e===-1?r:r.slice(e+1)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Pd(r,e){return e}class de{constructor(e,s,n,o){this.server=e,this.local=s||e,this.writable=!!n,this.xform=o||Pd}}let sr=null;function Rd(r){return!Qs(r)||r.length<2?r:si(r)}function ni(){if(sr)return sr;const r=[];r.push(new de("bucket")),r.push(new de("generation")),r.push(new de("metageneration")),r.push(new de("name","fullPath",!0));function e(i,a){return Rd(a)}const s=new de("name");s.xform=e,r.push(s);function n(i,a){return a!==void 0?Number(a):a}const o=new de("size");return o.xform=n,r.push(o),r.push(new de("timeCreated")),r.push(new de("updated")),r.push(new de("md5Hash",null,!0)),r.push(new de("cacheControl",null,!0)),r.push(new de("contentDisposition",null,!0)),r.push(new de("contentEncoding",null,!0)),r.push(new de("contentLanguage",null,!0)),r.push(new de("contentType",null,!0)),r.push(new de("metadata","customMetadata",!0)),sr=r,sr}function Od(r,e){function s(){const n=r.bucket,o=r.fullPath,i=new ye(n,o);return e._makeStorageReference(i)}Object.defineProperty(r,"ref",{get:s})}function Id(r,e,s){const n={};n.type="file";const o=s.length;for(let i=0;i<o;i++){const a=s[i];n[a.local]=a.xform(n,e[a.server])}return Od(n,r),n}function oi(r,e,s){const n=ri(e);return n===null?null:Id(r,n,s)}function Md(r,e,s,n){const o=ri(e);if(o===null||!Qs(o.downloadTokens))return null;const i=o.downloadTokens;if(i.length===0)return null;const a=encodeURIComponent;return i.split(",").map(c=>{const u=r.bucket,m=r.fullPath,x="/b/"+a(u)+"/o/"+a(m),y=en(x,s,n),g=Qo({alt:"media",token:c});return y+g})[0]}function Fd(r,e){const s={},n=e.length;for(let o=0;o<n;o++){const i=e[o];i.writable&&(s[i.server]=r[i.local])}return JSON.stringify(s)}class ii{constructor(e,s,n,o){this.url=e,this.method=s,this.handler=n,this.timeout=o,this.urlParams={},this.headers={},this.body=null,this.errorHandler=null,this.progressCallback=null,this.successCodes=[200],this.additionalRetryCodes=[]}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ai(r){if(!r)throw Xs()}function Ld(r,e){function s(n,o){const i=oi(r,o,e);return ai(i!==null),i}return s}function _d(r,e){function s(n,o){const i=oi(r,o,e);return ai(i!==null),Md(i,o,r.host,r._protocol)}return s}function li(r){function e(s,n){let o;return s.getStatus()===401?s.getErrorText().includes("Firebase App Check token is invalid")?o=Xc():o=Yc():s.getStatus()===402?o=Kc(r.bucket):s.getStatus()===403?o=Qc(r.path):o=n,o.status=s.getStatus(),o.serverResponse=n.serverResponse,o}return e}function $d(r){const e=li(r);function s(n,o){let i=e(n,o);return n.getStatus()===404&&(i=Jc(r.path)),i.serverResponse=o.serverResponse,i}return s}function Bd(r,e,s){const n=e.fullServerUrl(),o=en(n,r.host,r._protocol),i="GET",a=r.maxOperationRetryTime,l=new ii(o,i,_d(r,s),a);return l.errorHandler=$d(e),l}function Ud(r,e){return r&&r.contentType||e&&e.type()||"application/octet-stream"}function Hd(r,e,s){const n=Object.assign({},s);return n.fullPath=r.path,n.size=e.size(),n.contentType||(n.contentType=Ud(null,e)),n}function zd(r,e,s,n,o){const i=e.bucketOnlyServerUrl(),a={"X-Goog-Upload-Protocol":"multipart"};function l(){let j="";for(let w=0;w<2;w++)j=j+Math.random().toString().slice(2);return j}const d=l();a["Content-Type"]="multipart/related; boundary="+d;const c=Hd(e,n,o),u=Fd(c,s),m="--"+d+`\r
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class at{constructor(e,s){this._service=e,s instanceof ye?this._location=s:this._location=ye.makeFromUrl(s,e.host)}toString(){return"gs://"+this._location.bucket+"/"+this._location.path}_newRef(e,s){return new at(e,s)}get root(){const e=new ye(this._location.bucket,"");return this._newRef(this._service,e)}get bucket(){return this._location.bucket}get fullPath(){return this._location.path}get name(){return si(this._location.path)}get storage(){return this._service}get parent(){const e=Ed(this._location.path);if(e===null)return null;const s=new ye(this._location.bucket,e);return new at(this._service,s)}_throwIfRoot(e){if(this._location.path==="")throw ad(e)}}function Wd(r,e,s){r._throwIfRoot("uploadBytes");const n=zd(r.storage,r._location,ni(),new Ue(e,!0),s);return r.storage.makeRequestWithTokens(n,ci).then(o=>({metadata:o,ref:r}))}function Vd(r){r._throwIfRoot("getDownloadURL");const e=Bd(r.storage,r._location,ni());return r.storage.makeRequestWithTokens(e,ci).then(s=>{if(s===null)throw od();return s})}function Jd(r,e){const s=Ad(r._location.path,e),n=new ye(r._location.bucket,s);return new at(r.storage,n)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Kd(r){return/^[A-Za-z]+:\/\//.test(r)}function Yd(r,e){return new at(r,e)}function di(r,e){if(r instanceof tn){const s=r;if(s._bucket==null)throw sd();const n=new at(s,s._bucket);return e!=null?di(n,e):n}else return e!==void 0?Jd(r,e):r}function Xd(r,e){if(e&&Kd(e)){if(r instanceof tn)return Yd(r,e);throw Ds("To use ref(service, url), the first argument must be a Storage instance.")}else return di(r,e)}function Pn(r,e){const s=e==null?void 0:e[Yo];return s==null?null:ye.makeFromBucketSpec(s,r)}function Qd(r,e,s,n={}){r.host=`${e}:${s}`,r._protocol="http";const{mockUserToken:o}=n;o&&(r._overrideAuthToken=typeof o=="string"?o:va(o,r.app.options.projectId))}class tn{constructor(e,s,n,o,i){this.app=e,this._authProvider=s,this._appCheckProvider=n,this._url=o,this._firebaseVersion=i,this._bucket=null,this._host=Ko,this._protocol="https",this._appId=null,this._deleted=!1,this._maxOperationRetryTime=Wc,this._maxUploadRetryTime=Vc,this._requests=new Set,o!=null?this._bucket=ye.makeFromBucketSpec(o,this._host):this._bucket=Pn(this._host,this.app.options)}get host(){return this._host}set host(e){this._host=e,this._url!=null?this._bucket=ye.makeFromBucketSpec(this._url,e):this._bucket=Pn(e,this.app.options)}get maxUploadRetryTime(){return this._maxUploadRetryTime}set maxUploadRetryTime(e){An("time",0,Number.POSITIVE_INFINITY,e),this._maxUploadRetryTime=e}get maxOperationRetryTime(){return this._maxOperationRetryTime}set maxOperationRetryTime(e){An("time",0,Number.POSITIVE_INFINITY,e),this._maxOperationRetryTime=e}async _getAuthToken(){if(this._overrideAuthToken)return this._overrideAuthToken;const e=this._authProvider.getImmediate({optional:!0});if(e){const s=await e.getToken();if(s!==null)return s.accessToken}return null}async _getAppCheckToken(){const e=this._appCheckProvider.getImmediate({optional:!0});return e?(await e.getToken()).token:null}_delete(){return this._deleted||(this._deleted=!0,this._requests.forEach(e=>e.cancel()),this._requests.clear()),Promise.resolve()}_makeStorageReference(e){return new at(this,e)}_makeRequest(e,s,n,o,i=!0){if(this._deleted)return new ld(Xo());{const a=yd(e,this._appId,n,o,s,this._firebaseVersion,i);return this._requests.add(a),a.getPromise().then(()=>this._requests.delete(a),()=>this._requests.delete(a)),a}}async makeRequestWithTokens(e,s){const[n,o]=await Promise.all([this._getAuthToken(),this._getAppCheckToken()]);return this._makeRequest(e,s,n,o).getPromise()}}const Rn="@firebase/storage",On="0.13.2";/**
 * @license

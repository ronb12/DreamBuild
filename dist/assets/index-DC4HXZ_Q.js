import{initializeApp as yo}from"https://www.gstatic.com/firebasejs/10.14.1/firebase-app.js";import{getAuth as vo,signInWithPopup as jo,GithubAuthProvider as wo,GoogleAuthProvider as No}from"https://www.gstatic.com/firebasejs/10.14.1/firebase-auth.js";import{r as m,a as So,b as Co,R as Oe,g as ko}from"./react-vendor-DWvC8KHc.js";import{_ as To,C as Do,r as xn,S as Po,F as Ao,g as wr,a as Os,b as Eo,c as Ro,d as Io,i as Nr,e as ja,f as wa,o as Na,h as vs,j as ee,s as Oo,G as Lo,k as bn,l as be,m as Mo,n as Fo,p as $o,q as Ht,t as Gt,u as it,w as wt,v as rr}from"./firebase-yUj2_25M.js";import{_ as $e}from"./monaco-editor-BWpThiUx.js";import{S as ht,R as Te,C as W,B as ve,D as De,U as Xe,M as _o,a as Bo,b as Sr,L as yn,X as qr,c as Uo,G as he,T as Vr,d as Rt,e as Jr,m as L,f as Ls,Z as Ue,F as Ee,P as It,g as Dt,h as Sa,i as Qe,j as Ho,k as Ca,A as qe,l as Qt,n as Ot,o as ka,p as Ta,q as Ms,E as Zt,r as Go,s as zo,t as nr,u as Ds,v as Wo,w as qo,x as Be,y as Vo,z as Da,H as Jo,I as Le,J as Ce,K as Ps,N as ye,O as Ze,Q as Fs,V as we,W as es,Y as Yo,_ as pe,$ as Cr,a0 as _e,a1 as ns,a2 as Ko,a3 as Pa,a4 as Xo,a5 as Aa,a6 as Qo,a7 as Ea,a8 as Zo,a9 as el,aa as yt,ab as tl,ac as Pt,ad as Ra,ae as sl,af as Yr,ag as rl,ah as ar,ai as et,aj as kr,ak as Tr,al as Dr,am as nl,an as al,ao as il,ap as ol,aq as ll,ar as Je,as as gt,at as Pr,au as Ia,av as cl,aw as dl,ax as ir,ay as ul,az as vn,aA as ml,aB as pl}from"./ui-vendor-CHaMoLib.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))n(a);new MutationObserver(a=>{for(const i of a)if(i.type==="childList")for(const o of i.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&n(o)}).observe(document,{childList:!0,subtree:!0});function r(a){const i={};return a.integrity&&(i.integrity=a.integrity),a.referrerPolicy&&(i.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?i.credentials="include":a.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function n(a){if(a.ep)return;a.ep=!0;const i=r(a);fetch(a.href,i)}})();const hl={apiKey:"AIzaSyCWjBfZHPHDI4rXRStWPP48lRZVJquWH38",authDomain:"dreambuild-2024-app.firebaseapp.com",projectId:"dreambuild-2024-app",storageBucket:"dreambuild-2024-app.firebasestorage.app",messagingSenderId:"780467658601",appId:"1:780467658601:web:833a9373c15fa3be0be7f8"},Oa=yo(hl),gl=vo(Oa);window.firebase={auth:()=>gl,GoogleAuthProvider:No,GithubAuthProvider:wo,signInWithPopup:jo};window.firebaseApp=Oa;console.log("Firebase loaded globally with providers:",!!window.firebase);var La={exports:{}},$s={};/**
 * @license React
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class je{constructor(t,r){this.bucket=t,this.path_=r}get path(){return this.path_}get isRoot(){return this.path.length===0}fullServerUrl(){const t=encodeURIComponent;return"/b/"+t(this.bucket)+"/o/"+t(this.path)}bucketOnlyServerUrl(){return"/b/"+encodeURIComponent(this.bucket)+"/o"}static makeFromBucketSpec(t,r){let n;try{n=je.makeFromUrl(t,r)}catch{return new je(t,"")}if(n.path==="")return n;throw Nd(t)}static makeFromUrl(t,r){let n=null;const a="([A-Za-z0-9.\\-_]+)";function i(w){w.path.charAt(w.path.length-1)==="/"&&(w.path_=w.path_.slice(0,-1))}const o="(/(.*))?$",l=new RegExp("^gs://"+a+o,"i"),d={bucket:1,path:3};function c(w){w.path_=decodeURIComponent(w.path)}const u="v[A-Za-z0-9_]+",p=r.replace(/[.]/g,"\\."),g="(/([^?#]*).*)?$",y=new RegExp(`^https?://${p}/${u}/b/${a}/o${g}`,"i"),x={bucket:1,path:3},b=r===si?"(?:storage.googleapis.com|storage.cloud.google.com)":r,h="([^?#]*)",N=new RegExp(`^https?://${b}/${a}/${h}`,"i"),S=[{regex:l,indices:d,postModify:i},{regex:y,indices:x,postModify:c},{regex:N,indices:{bucket:1,path:2},postModify:c}];for(let w=0;w<S.length;w++){const f=S[w],A=f.regex.exec(t);if(A){const R=A[f.indices.bucket];let P=A[f.indices.path];P||(P=""),n=new je(R,P),f.postModify(n);break}}if(n==null)throw wd(t);return n}}class Pd{constructor(t){this.promise_=Promise.reject(t)}getPromise(){return this.promise_}cancel(t=!1){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ld{constructor(t,r,n,a,i,o,l,d,c,u,p,g=!0){this.url_=t,this.method_=r,this.headers_=n,this.body_=a,this.successCodes_=i,this.additionalRetryCodes_=o,this.callback_=l,this.errorCallback_=d,this.timeout_=c,this.progressCallback_=u,this.connectionFactory_=p,this.retry=g,this.pendingConnection_=null,this.backoffId_=null,this.canceled_=!1,this.appDelete_=!1,this.promise_=new Promise((y,x)=>{this.resolve_=y,this.reject_=x,this.start_()})}start_(){const t=(n,a)=>{if(a){n(!1,new ms(!1,null,!0));return}const i=this.connectionFactory_();this.pendingConnection_=i;const o=l=>{const d=l.loaded,c=l.lengthComputable?l.total:-1;this.progressCallback_!==null&&this.progressCallback_(d,c)};this.progressCallback_!==null&&i.addUploadProgressListener(o),i.send(this.url_,this.method_,this.body_,this.headers_).then(()=>{this.progressCallback_!==null&&i.removeUploadProgressListener(o),this.pendingConnection_=null;const l=i.getErrorCode()===mt.NO_ERROR,d=i.getStatus();if(!l||Od(d,this.additionalRetryCodes_)&&this.retry){const u=i.getErrorCode()===mt.ABORT;n(!1,new ms(!1,null,u));return}const c=this.successCodes_.indexOf(d)!==-1;n(!0,new ms(c,i))})},r=(n,a)=>{const i=this.resolve_,o=this.reject_,l=a.connection;if(a.wasSuccessCode)try{const d=this.callback_(l,l.getResponse());Rd(d)?i(d):i()}catch(d){o(d)}else if(l!==null){const d=tn();d.serverResponse=l.getErrorText(),this.errorCallback_?o(this.errorCallback_(l,d)):o(d)}else if(a.canceled){const d=this.appDelete_?ni():jd();o(d)}else{const d=vd();o(d)}};this.canceled_?r(!1,new ms(!1,null,!0)):this.backoffId_=Ad(t,r,this.timeout_)}getPromise(){return this.promise_}cancel(t){this.canceled_=!0,this.appDelete_=t||!1,this.backoffId_!==null&&Ed(this.backoffId_),this.pendingConnection_!==null&&this.pendingConnection_.abort()}}class ms{constructor(t,r,n){this.wasSuccessCode=t,this.connection=r,this.canceled=!!n}}function Md(s,t){t!==null&&t.length>0&&(s.Authorization="Firebase "+t)}function Fd(s,t){s["X-Firebase-Storage-Version"]="webjs/"+(t??"AppManager")}function $d(s,t){t&&(s["X-Firebase-GMPID"]=t)}function _d(s,t){t!==null&&(s["X-Firebase-AppCheck"]=t)}function Bd(s,t,r,n,a,i,o=!0){const l=ai(s.urlParams),d=s.url+l,c=Object.assign({},s.headers);return $d(c,t),Md(c,r),Fd(c,i),_d(c,n),new Ld(d,s.method,c,s.body,s.successCodes,s.additionalRetryCodes,s.handler,s.errorHandler,s.timeout,s.progressCallback,a,o)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Qd(s,t){return t}class me{constructor(t,r,n,a){this.server=t,this.local=r||t,this.writable=!!n,this.xform=a||Qd}}let ps=null;function Zd(s){return!sn(s)||s.length<2?s:di(s)}function ui(){if(ps)return ps;const s=[];s.push(new me("bucket")),s.push(new me("generation")),s.push(new me("metageneration")),s.push(new me("name","fullPath",!0));function t(i,o){return Zd(o)}const r=new me("name");r.xform=t,s.push(r);function n(i,o){return o!==void 0?Number(o):o}const a=new me("size");return a.xform=n,s.push(a),s.push(new me("timeCreated")),s.push(new me("updated")),s.push(new me("md5Hash",null,!0)),s.push(new me("cacheControl",null,!0)),s.push(new me("contentDisposition",null,!0)),s.push(new me("contentEncoding",null,!0)),s.push(new me("contentLanguage",null,!0)),s.push(new me("contentType",null,!0)),s.push(new me("metadata","customMetadata",!0)),ps=s,ps}function eu(s,t){function r(){const n=s.bucket,a=s.fullPath,i=new je(n,a);return t._makeStorageReference(i)}Object.defineProperty(s,"ref",{get:r})}function tu(s,t,r){const n={};n.type="file";const a=r.length;for(let i=0;i<a;i++){const o=r[i];n[o.local]=o.xform(n,t[o.server])}return eu(n,s),n}function mi(s,t,r){const n=ci(t);return n===null?null:tu(s,n,r)}function su(s,t,r,n){const a=ci(t);if(a===null||!sn(a.downloadTokens))return null;const i=a.downloadTokens;if(i.length===0)return null;const o=encodeURIComponent;return i.split(",").map(c=>{const u=s.bucket,p=s.fullPath,g="/b/"+o(u)+"/o/"+o(p),y=nn(g,r,n),x=ai({alt:"media",token:c});return y+x})[0]}function ru(s,t){const r={},n=t.length;for(let a=0;a<n;a++){const i=t[a];i.writable&&(r[i.server]=s[i.local])}return JSON.stringify(r)}class pi{constructor(t,r,n,a){this.url=t,this.method=r,this.handler=n,this.timeout=a,this.urlParams={},this.headers={},this.body=null,this.errorHandler=null,this.progressCallback=null,this.successCodes=[200],this.additionalRetryCodes=[]}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ft{constructor(t,r){this._service=t,r instanceof je?this._location=r:this._location=je.makeFromUrl(r,t.host)}toString(){return"gs://"+this._location.bucket+"/"+this._location.path}_newRef(t,r){return new ft(t,r)}get root(){const t=new je(this._location.bucket,"");return this._newRef(this._service,t)}get bucket(){return this._location.bucket}get fullPath(){return this._location.path}get name(){return di(this._location.path)}get storage(){return this._service}get parent(){const t=Kd(this._location.path);if(t===null)return null;const r=new je(this._location.bucket,t);return new ft(this._service,r)}_throwIfRoot(t){if(this._location.path==="")throw Dd(t)}}function pu(s,t,r){s._throwIfRoot("uploadBytes");const n=du(s.storage,s._location,ui(),new We(t,!0),r);return s.storage.makeRequestWithTokens(n,fi).then(a=>({metadata:a,ref:s}))}function hu(s){s._throwIfRoot("getDownloadURL");const t=ou(s.storage,s._location,ui());return s.storage.makeRequestWithTokens(t,fi).then(r=>{if(r===null)throw kd();return r})}function gu(s,t){const r=Xd(s._location.path,t),n=new je(s._location.bucket,r);return new ft(s.storage,n)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");

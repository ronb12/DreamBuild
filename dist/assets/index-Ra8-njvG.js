...
${R}`),console.log("🎮 Preview Debug - Final HTML length:",R.length),console.log("🎮 Preview Debug - HTML contains <style>:",R.includes("<style>")),console.log("🎮 Preview Debug - HTML contains <script>:",R.includes("<script>")),console.log("🎮 Preview Debug - HTML preview:",R.substring(0,500)+"...");const k=e.current;k.srcdoc=R,k.onload=()=>{n(!1),l(null)},k.onerror=()=>{n(!1),l("Failed to load preview")}}catch(b){console.error("Preview update error:",b),n(!1),l("Preview update failed")}},m=b=>b?b.replace(/`/g,"\\`").replace(/\${/g,"\\${").replace(/\$/g,"\\$"):"",x=()=>{if(console.log("🎮 Creating React preview..."),!e.current){console.log("🎮 createReactPreview: iframeRef.current is null");return}try{const b=r.files["src/components/GameApp.jsx"]||"",j=r.files["src/components/GameComponent.jsx"]||"",w=r.files["src/components/TempleRunUI.jsx"]||"",y=r.files["src/components/RunnerPlayer.jsx"]||"",D=r.files["src/components/Obstacle.jsx"]||"",A=r.files["src/components/Coin.jsx"]||"",M=r.files["src/components/Player.jsx"]||"",$=r.files["src/components/GameApp.css"]||"",E=r.files["src/components/GameComponent.css"]||"",R=r.files["src/components/TempleRunUI.css"]||"",k=r.files["src/components/RunnerPlayer.css"]||"",_=r.files["src/components/Obstacle.css"]||"",T=r.files["src/components/Coin.css"]||"",P=r.files["src/components/Player.css"]||"",L=w||y||D,q=M||A,G=j.toLowerCase(),ce=G.includes("temple run")||G.includes("lane")||G.includes("jump")||G.includes("slide")||G.includes("obstacle")||G.includes("endless runner"),ge=L||ce,U=q&&!ge;console.log("🎮 Preview Debug - Available files:"),console.log("🎮 - templeRunUIFile:",!!w),console.log("🎮 - runnerPlayerFile:",!!y),console.log("🎮 - obstacleFile:",!!D),console.log("🎮 - playerFile:",!!M),console.log("🎮 - coinFile:",!!A),console.log("🎮 - hasTempleRunFiles:",L),console.log("🎮 - hasTempleRunContent:",ce),console.log("🎮 - isTempleRun:",ge),console.log("🎮 - isCoinCollector:",U),console.log("🎮 - All project files:",Object.keys(r.files)),console.log("🎮 FINAL GAME TYPE DECISION:"),console.log(ge?"🎮 ✅ RENDERING TEMPLE RUN GAME":U?"🎮 ✅ RENDERING COIN COLLECTOR GAME":"🎮 ✅ RENDERING DEFAULT GAME");const W=`
      <!DOCTYPE html>
      <html lang="en">
      <head>
        <meta charset="UTF-8">

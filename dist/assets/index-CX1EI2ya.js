 ...
 */var Ua=p,za=Symbol.for("react.element"),Ha=Symbol.for("react.fragment"),Ga=Object.prototype.hasOwnProperty,Wa=Ua.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,qa={key:!0,ref:!0,__self:!0,__source:!0};function vo(t,e,s){var n,o={},i=null,a=null;s!==void 0&&(i=""+s),e.key!==void 0&&(i=""+e.key),e.ref!==void 0&&(a=e.ref);for(n in e)Ga.call(e,n)&&!qa.hasOwnProperty(n)&&(o[n]=e[n]);if(t&&t.defaultProps)for(n in e=t.defaultProps,e)o[n]===void 0&&(o[n]=e[n]);return{$$typeof:za,type:t,key:i,ref:a,props:o,_owner:Wa.current}}Dr.Fragment=Ha;Dr.jsx=vo;Dr.jsxs=vo;yo.exports=Dr;var r=yo.exports,wo,dn=ra;wo=dn.createRoot,dn.hydrateRoot;/**
...
${this.customData.serverResponse}`:this.message=this._baseMessage}}var Z;(function(t){t.UNKNOWN="unknown",t.OBJECT_NOT_FOUND="object-not-found",t.BUCKET_NOT_FOUND="bucket-not-found",t.PROJECT_NOT_FOUND="project-not-found",t.QUOTA_EXCEEDED="quota-exceeded",t.UNAUTHENTICATED="unauthenticated",t.UNAUTHORIZED="unauthorized",t.UNAUTHORIZED_APP="unauthorized-app",t.RETRY_LIMIT_EXCEEDED="retry-limit-exceeded",t.INVALID_CHECKSUM="invalid-checksum",t.CANCELED="canceled",t.INVALID_EVENT_NAME="invalid-event-name",t.INVALID_URL="invalid-url",t.INVALID_DEFAULT_BUCKET="invalid-default-bucket",t.NO_DEFAULT_BUCKET="no-default-bucket",t.CANNOT_SLICE_BLOB="cannot-slice-blob",t.SERVER_FILE_WRONG_SIZE="server-file-wrong-size",t.NO_DOWNLOAD_URL="no-download-url",t.INVALID_ARGUMENT="invalid-argument",t.INVALID_ARGUMENT_COUNT="invalid-argument-count",t.APP_DELETED="app-deleted",t.INVALID_ROOT_OPERATION="invalid-root-operation",t.INVALID_FORMAT="invalid-format",t.INTERNAL_ERROR="internal-error",t.UNSUPPORTED_ENVIRONMENT="unsupported-environment"})(Z||(Z={}));function Kr(t){return"storage/"+t}function Ws(){const t="An unknown error occurred, please check the error payload for server response.";return new ee(Z.UNKNOWN,t)}function Bc(t){return new ee(Z.OBJECT_NOT_FOUND,"Object '"+t+"' does not exist.")}function Uc(t){return new ee(Z.QUOTA_EXCEEDED,"Quota for bucket '"+t+"' exceeded, please view quota on https://firebase.google.com/pricing/.")}function zc(){const t="User is not authenticated, please authenticate using Firebase Authentication and try again.";return new ee(Z.UNAUTHENTICATED,t)}function Hc(){return new ee(Z.UNAUTHORIZED_APP,"This app does not have permission to access Firebase Storage on this project.")}function Gc(t){return new ee(Z.UNAUTHORIZED,"User does not have permission to access '"+t+"'.")}function Wc(){return new ee(Z.RETRY_LIMIT_EXCEEDED,"Max retry time for operation exceeded, please try again.")}function qc(){return new ee(Z.CANCELED,"User canceled the upload/download.")}function Vc(t){return new ee(Z.INVALID_URL,"Invalid URL '"+t+"'.")}function Jc(t){return new ee(Z.INVALID_DEFAULT_BUCKET,"Invalid default bucket '"+t+"'.")}function Kc(){return new ee(Z.NO_DEFAULT_BUCKET,"No default bucket found. Did you set the '"+Uo+"' property when initializing the app?")}function Yc(){return new ee(Z.CANNOT_SLICE_BLOB,"Cannot slice blob for upload. Please retry the upload.")}function Xc(){return new ee(Z.NO_DOWNLOAD_URL,"The given file does not have any download URLs.")}function Qc(t){return new ee(Z.UNSUPPORTED_ENVIRONMENT,`${t} is missing. Make sure to install the required polyfills. See https://firebase.google.com/docs/web/environments-js-sdk#polyfills for more information.`)}function js(t){return new ee(Z.INVALID_ARGUMENT,t)}function zo(){return new ee(Z.APP_DELETED,"The Firebase app was deleted.")}function Zc(t){return new ee(Z.INVALID_ROOT_OPERATION,"The operation '"+t+"' cannot be performed on a root reference, create a non-root reference using child, such as .child('file.png').")}function Pt(t,e){return new ee(Z.INVALID_FORMAT,"String does not match format '"+t+"': "+e)}function Tt(t){throw new ee(Z.INTERNAL_ERROR,"Internal error: "+t)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const De={RAW:"raw",BASE64:"base64",BASE64URL:"base64url",DATA_URL:"data_url"};class Yr{constructor(e,s){this.data=e,this.contentType=s||null}}function gd(t,e){switch(t){case De.RAW:return new Yr(Go(e));case De.BASE64:case De.BASE64URL:return new Yr(Wo(t,e));case De.DATA_URL:return new Yr(bd(e),yd(e))}throw Ws()}function Go(t){const e=[];for(let s=0;s<t.length;s++){let n=t.charCodeAt(s);if(n<=127)e.push(n);else if(n<=2047)e.push(192|n>>6,128|n&63);else if((n&64512)===55296)if(!(s<t.length-1&&(t.charCodeAt(s+1)&64512)===56320))e.push(239,191,189);else{const i=n,a=t.charCodeAt(++s);n=65536|(i&1023)<<10|a&1023,e.push(240|n>>18,128|n>>12&63,128|n>>6&63,128|n&63)}else(n&64512)===56320?e.push(239,191,189):e.push(224|n>>12,128|n>>6&63,128|n&63)}return new Uint8Array(e)}function xd(t){let e;try{e=decodeURIComponent(t)}catch{throw Pt(De.DATA_URL,"Malformed data URL.")}return Go(e)}function Wo(t,e){switch(t){case De.BASE64:{const o=e.indexOf("-")!==-1,i=e.indexOf("_")!==-1;if(o||i)throw Pt(t,"Invalid character '"+(o?"-":"_")+"' found: is it base64url encoded?");break}case De.BASE64URL:{const o=e.indexOf("+")!==-1,i=e.indexOf("/")!==-1;if(o||i)throw Pt(t,"Invalid character '"+(o?"+":"/")+"' found: is it base64 encoded?");e=e.replace(/-/g,"+").replace(/_/g,"/");break}}let s;try{s=fd(e)}catch(o){throw o.message.includes("polyfill")?o:Pt(t,"Invalid character found")}const n=new Uint8Array(s.length);for(let o=0;o<s.length;o++)n[o]=s.charCodeAt(o);return n}class qo{constructor(e){this.base64=!1,this.contentType=null;const s=e.match(/^data:([^,]+)?,/);if(s===null)throw Pt(De.DATA_URL,"Must be formatted 'data:[<mediatype>][;base64],<data>");const n=s[1]||null;n!=null&&(this.base64=vd(n,";base64"),this.contentType=this.base64?n.substring(0,n.length-7):n),this.rest=e.substring(e.indexOf(",")+1)}}function bd(t){const e=new qo(t);return e.base64?Wo(De.BASE64,e.rest):xd(e.rest)}function yd(t){return new qo(t).contentType}function vd(t,e){return t.length>=e.length?t.substring(t.length-e.length)===e:!1}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
${P}`),console.log("🎮 Preview Debug - Final HTML length:",P.length),console.log("🎮 Preview Debug - HTML contains <style>:",P.includes("<style>")),console.log("🎮 Preview Debug - HTML contains <script>:",P.includes("<script>")),console.log("🎮 Preview Debug - HTML preview:",P.substring(0,500)+"...");const q=e.current;q.srcdoc=P,q.onload=()=>{n(!1),l(null)},q.onerror=()=>{n(!1),l("Failed to load preview")}}catch(j){console.error("Preview update error:",j),n(!1),l("Preview update failed")}},u=j=>j?j.replace(/`/g,"\\`").replace(/\${/g,"\\${").replace(/\$/g,"\\$"):"",g=()=>{if(console.log("🎮 Creating React preview..."),!e.current){console.log("🎮 createReactPreview: iframeRef.current is null");return}try{const j=t.files["src/components/GameApp.jsx"]||"",v=t.files["src/components/GameComponent.jsx"]||"",b=t.files["src/components/TempleRunUI.jsx"]||"",x=t.files["src/components/RunnerPlayer.jsx"]||"",k=t.files["src/components/Obstacle.jsx"]||"",A=t.files["src/components/Coin.jsx"]||"",S=t.files["src/components/Player.jsx"]||"",I=t.files["src/components/GameApp.css"]||"",E=t.files["src/components/GameComponent.css"]||"",P=t.files["src/components/TempleRunUI.css"]||"",q=t.files["src/components/RunnerPlayer.css"]||"",B=t.files["src/components/Obstacle.css"]||"",T=t.files["src/components/Coin.css"]||"",F=t.files["src/components/Player.css"]||"",_=b||x||k,J=S||A,W=v.toLowerCase(),le=W.includes("temple run")||W.includes("lane")||W.includes("jump")||W.includes("slide")||W.includes("obstacle")||W.includes("endless runner"),xe=_||le,$=J&&!xe;console.log("🎮 Preview Debug - Available files:"),console.log("🎮 - templeRunUIFile:",!!b),console.log("🎮 - runnerPlayerFile:",!!x),console.log("🎮 - obstacleFile:",!!k),console.log("🎮 - playerFile:",!!S),console.log("🎮 - coinFile:",!!A),console.log("🎮 - hasTempleRunFiles:",_),console.log("🎮 - hasTempleRunContent:",le),console.log("🎮 - isTempleRun:",xe),console.log("🎮 - isCoinCollector:",$),console.log("🎮 - All project files:",Object.keys(t.files)),console.log("🎮 FINAL GAME TYPE DECISION:"),console.log(xe?"🎮 ✅ RENDERING TEMPLE RUN GAME":$?"🎮 ✅ RENDERING COIN COLLECTOR GAME":"🎮 ✅ RENDERING DEFAULT GAME");const G=`
      <!DOCTYPE html>
      <html lang="en">
      <head>
        <meta charset="UTF-8">
...
${_}`},v=(T,F)=>{const _=F.getDropResult();if(!_)return;const J={id:`component-${Date.now()}`,type:T.type,name:T.name,position:{x:_.x,y:_.y},size:{width:200,height:100},styles:{position:"absolute",left:`${_.x}px`,top:`${_.y}px`,width:"200px",height:"100px",border:"1px solid #ddd",padding:"10px",backgroundColor:"#fff"},content:T.name,properties:{}};o(W=>[...W,J])},b=T=>{a(T),c(!0)},x=(T,F)=>{if(!i)return;const _={...i,[T]:F,styles:{...i.styles,[T]:F}};o(J=>J.map(W=>W.id===i.id?_:W)),a(_)},k=()=>`
.app {
  position: relative;
  width: 100%;
  min-height: 100vh;

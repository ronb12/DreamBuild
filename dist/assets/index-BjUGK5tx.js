import{r as p,a as da,b as ua,R as De,g as ma}from"./react-vendor-DWvC8KHc.js";import{_ as pa,C as ha,r as pn,S as fa,F as ga,g as fs,a as Tr,b as xa,c as ba,d as ya,i as yr,e as $s,f as Bs,o as Us,h as cr,j as V,s as va,G as wa,k as hn,l as be,m as ja,n as Na,u as Zt,p as Rt,q as de,t as we,w as ue,v as Ot,x as Fe,y as Yr,z as dr,A as Sa,B as It}from"./firebase-_l3dWQPc.js";import{_ as rt}from"./monaco-editor-BWpThiUx.js";import{S as vt,R as Ee,C as X,D as yt,U as gs,M as Ca,a as ka,b as xs,L as fn,X as Ta,c as Da,G as pe,T as Hs,d as vr,e as zs,m as R,f as bo,Z as wt,F as ze,P as wr,g as gt,h as yo,i as We,j as Ea,k as vo,A as Be,l as Ht,n as jt,o as bs,p as wo,q as Dr,E as zt,r as Aa,s as Pa,B as Xr,t as jr,u as Ra,v as Oa,w as Ie,x as Ve,y as Er,z as Ae,H as Gs,I as Ia,J as it,K as Nt,N as ys,O as Ue,Q as jo,V as Ma,W as No,Y as La,_ as So,$ as Co,a0 as Fa,a1 as qs,a2 as _a,a3 as $a,a4 as Ba,a5 as Ar,a6 as xt,a7 as Ua,a8 as ko,a9 as Ha,aa as za,ab as Ga,ac as ur,ad as qa,ae as Qr,af as gn,ag as vs,ah as ws,ai as js,aj as Wa,ak as Va,al as Ja}from"./ui-vendor-6CVz1JuZ.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))n(o);new MutationObserver(o=>{for(const i of o)if(i.type==="childList")for(const a of i.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&n(a)}).observe(document,{childList:!0,subtree:!0});function s(o){const i={};return o.integrity&&(i.integrity=o.integrity),o.referrerPolicy&&(i.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?i.credentials="include":o.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function n(o){if(o.ep)return;o.ep=!0;const i=s(o);fetch(o.href,i)}})();var To={exports:{}},Pr={};/**
 * @license React
...
`,Mc="0%{opacity:0;} 100%{opacity:1;}",Lc="0%{opacity:1;} 100%{opacity:0;}",Fc=Xe("div")`
  display: flex;
  align-items: center;
  background: #fff;
  color: #363636;
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function cd(r,e,s){let n=1,o=null,i=null,a=!1,l=0;function d(){return l===2}let c=!1;function u(...h){c||(c=!0,e.apply(null,h))}function m(h){o=setTimeout(()=>{o=null,r(v,d())},h)}function x(){i&&clearTimeout(i)}function v(h,...C){if(c){x();return}if(h){x(),u.call(null,h,...C);return}if(d()||a){x(),u.call(null,h,...C);return}n<64&&(n*=2);let j;l===1?(l=2,j=0):j=(n+Math.random())*1e3,m(j)}let g=!1;function f(h){g||(g=!0,x(),!c&&(o!==null?(h||(l=2),clearTimeout(o),m(0)):h||(l=1)))}return m(0),i=setTimeout(()=>{a=!0,f(!0)},s),f}function dd(r){r(!1)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ii(r){if(!r)throw Xs()}function Fd(r,e){function s(n,o){const i=ni(r,o,e);return ii(i!==null),i}return s}function _d(r,e){function s(n,o){const i=ni(r,o,e);return ii(i!==null),Md(i,o,r.host,r._protocol)}return s}function ai(r){function e(s,n){let o;return s.getStatus()===401?s.getErrorText().includes("Firebase App Check token is invalid")?o=Xc():o=Yc():s.getStatus()===402?o=Kc(r.bucket):s.getStatus()===403?o=Qc(r.path):o=n,o.status=s.getStatus(),o.serverResponse=n.serverResponse,o}return e}function $d(r){const e=ai(r);function s(n,o){let i=e(n,o);return n.getStatus()===404&&(i=Jc(r.path)),i.serverResponse=o.serverResponse,i}return s}function Bd(r,e,s){const n=e.fullServerUrl(),o=en(n,r.host,r._protocol),i="GET",a=r.maxOperationRetryTime,l=new oi(o,i,_d(r,s),a);return l.errorHandler=$d(e),l}function Ud(r,e){return r&&r.contentType||e&&e.type()||"application/octet-stream"}function Hd(r,e,s){const n=Object.assign({},s);return n.fullPath=r.path,n.size=e.size(),n.contentType||(n.contentType=Ud(null,e)),n}function zd(r,e,s,n,o){const i=e.bucketOnlyServerUrl(),a={"X-Goog-Upload-Protocol":"multipart"};function l(){let j="";for(let w=0;w<2;w++)j=j+Math.random().toString().slice(2);return j}const d=l();a["Content-Type"]="multipart/related; boundary="+d;const c=Hd(e,n,o),u=Ld(c,s),m="--"+d+`\r
...
`),commands:e,projectDir:s};return console.log("✅ Terminal commands executed successfully"),o}catch(o){return console.error("❌ Terminal command execution failed:",o),{success:!1,output:`Error: ${o.message}`,commands:e,error:o.message}}}}const sr=new au,lu=()=>{const{currentProject:r,switchFile:e,updateFile:s,saveProject:n,createNewProject:o,updateConfig:i}=Le(),[a,l]=p.useState(!1),[d,c]=p.useState(""),[u,m]=p.useState(!1),[x,v]=p.useState(!1),[g,f]=p.useState(!1),[h,C]=p.useState("firebase"),[b,j]=p.useState(!1),[w,y]=p.useState(""),[D,A]=p.useState({show:!1,x:0,y:0,filename:""}),I=p.useRef(null),F={"index.html":"🌐","style.css":"🎨","script.js":"⚡","components.jsx":"🧩","package.json":"📦","README.md":"📖","server.js":"🖥️","database.js":"🗄️","auth.js":"🔐","api.js":"🔌"},N=S=>F[S]||"📄",E=S=>{e(S)},z=(S,M)=>{S.preventDefault(),A({show:!0,x:S.clientX,y:S.clientY,filename:M})},$=S=>{const{filename:M}=D;switch(A({show:!1,x:0,y:0,filename:""}),S){case"download":W(M);break;case"delete":L(M);break;case"rename":_.info("Rename functionality coming soon!");break;case"copy":_.info("Copy functionality coming soon!");break}},T=()=>{A({show:!1,x:0,y:0,filename:""})};p.useEffect(()=>{const S=M=>{I.current&&!I.current.contains(M.target)&&T()};return D.show&&document.addEventListener("mousedown",S),()=>{document.removeEventListener("mousedown",S)}},[D.show]);const P=()=>{if(d.trim()){const S=d.includes(".")?d:`${d}.js`;s(S,""),e(S),c(""),l(!1),_.success(`Created ${S}`)}},L=S=>{if(Object.keys(r.files).length<=1){_.error("Cannot delete the last file");return}if(confirm(`Delete ${S}?`)){const M={...r.files};if(delete M[S],Object.keys(M).forEach(O=>{r.files[O]=M[O]}),r.activeFile===S){const O=Object.keys(M);e(O[0])}_.success(`Deleted ${S}`)}},W=S=>{const M=r.files[S]||"",O=new Blob([M],{type:"text/plain"}),K=URL.createObjectURL(O),re=document.createElement("a");re.href=K,re.download=S,document.body.appendChild(re),re.click(),document.body.removeChild(re),URL.revokeObjectURL(K),_.success(`Downloaded ${S}`)},q=()=>{const S={name:r.name,files:r.files,config:r.config,timestamp:new Date().toISOString()},M=new Blob([JSON.stringify(S,null,2)],{type:"application/json"}),O=URL.createObjectURL(M),K=document.createElement("a");K.href=O,K.download=`${r.name}.json`,document.body.appendChild(K),K.click(),document.body.removeChild(K),URL.revokeObjectURL(O),_.success("Project downloaded!")},le=S=>{const M=S.target.files[0];if(M){const O=new FileReader;O.onload=K=>{s(M.name,K.target.result),e(M.name),_.success(`Uploaded ${M.name}`)},O.readAsText(M)}},ge=async()=>{if(!w.trim()){_.error("Please enter a project name");return}if(Object.keys(r.files).length===0){_.error("Please generate some code first");return}f(!0);try{const S=await B(r,w),M=[];if(b){_.info("Deploying to both Firebase and GitHub...");const[O,K]=await Promise.allSettled([sr.deployToFirebase(S,w),sr.deployToGitHub(S,w)]);if(O.status==="fulfilled"&&O.value.success&&M.push({platform:"Firebase",...O.value}),K.status==="fulfilled"&&K.value.success&&M.push({platform:"GitHub",...K.value}),M.length===2)_.success("Successfully deployed to both Firebase and GitHub!");else if(M.length===1)_.success(`Deployed to ${M[0].platform} (${M.length===1?"one":"both"} platform${M.length===1?"":"s"} failed)`);else throw new Error("Both deployments failed")}else{let O;h==="firebase"?O=await sr.deployToFirebase(S,w):h==="github"&&(O=await sr.deployToGitHub(S,w)),O.success&&(M.push({platform:h,...O}),_.success(`Successfully deployed to ${O.platform}!`))}M.forEach(O=>{O.url&&window.open(O.url,"_blank"),O.instructions&&(console.log(`${O.platform} deployment instructions:`,O.instructions),_.success(`Check console for ${O.platform} Pages setup instructions`))}),v(!1),y(""),j(!1)}catch(S){_.error(`Deployment failed: ${S.message}`)}finally{f(!1)}},B=async(S,M)=>{const O={...S};return O.files["index.html"]||(O.files["index.html"]=G(M)),O.files["package.json"]||(O.files["package.json"]=J(M,O.config)),O.files["README.md"]||(O.files["README.md"]=ne(M,O.config)),O.files["index.html"]=Pe(O.files["index.html"],M),O.files["manifest.json"]||(O.files["manifest.json"]=oe(M)),O},G=S=>`<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
...
<body>
    <div style="display: flex; align-items: center; justify-content: center; min-height: 100vh; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', 'Roboto', sans-serif; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white;">
        <div style="text-align: center; padding: 40px; background: rgba(255,255,255,0.1); border-radius: 20px; backdrop-filter: blur(10px); border: 1px solid rgba(255,255,255,0.2);">
            <h1 style="font-size: 2.5rem; margin-bottom: 20px;">🚀 ${S}</h1>
...
</html>`,J=(S,M)=>JSON.stringify({name:S.toLowerCase().replace(/[^a-z0-9-]/g,"-"),version:"1.0.0",description:`Built with DreamBuild - ${S}`,main:"index.html",scripts:{start:"npx serve .",build:"echo 'Static site - no build required'",deploy:"echo 'Deploy using DreamBuild deployment system'"},keywords:["dreambuild","ai-generated","web-app",M.appType||"frontend"],author:"DreamBuild AI",license:"MIT",engines:{node:">=14.0.0"},dependencies:{},devDependencies:{serve:"^14.0.0"}},null,2),ne=(S,M)=>{var O;return`# ${S}
...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)}function xu(r,e,s){return e in r?Object.defineProperty(r,e,{value:s,enumerable:!0,configurable:!0,writable:!0}):r[e]=s,r}function Ln(r,e){var s=Object.keys(r);if(Object.getOwnPropertySymbols){var n=Object.getOwnPropertySymbols(r);e&&(n=n.filter(function(o){return Object.getOwnPropertyDescriptor(r,o).enumerable})),s.push.apply(s,n)}return s}function Fn(r){for(var e=1;e<arguments.length;e++){var s=arguments[e]!=null?arguments[e]:{};e%2?Ln(Object(s),!0).forEach(function(n){xu(r,n,s[n])}):Object.getOwnPropertyDescriptors?Object.defineProperties(r,Object.getOwnPropertyDescriptors(s)):Ln(Object(s)).forEach(function(n){Object.defineProperty(r,n,Object.getOwnPropertyDescriptor(s,n))})}return r}function bu(){for(var r=arguments.length,e=new Array(r),s=0;s<r;s++)e[s]=arguments[s];return function(n){return e.reduceRight(function(o,i){return i(o)},n)}}function _t(r){return function e(){for(var s=this,n=arguments.length,o=new Array(n),i=0;i<n;i++)o[i]=arguments[i];return o.length>=r.length?r.apply(this,o):function(){for(var a=arguments.length,l=new Array(a),d=0;d<a;d++)l[d]=arguments[d];return e.apply(s,[].concat(o,l))}}}function Cr(r){return{}.toString.call(r).includes("Object")}function yu(r){return!Object.keys(r).length}function Wt(r){return typeof r=="function"}function vu(r,e){return Object.prototype.hasOwnProperty.call(r,e)}function wu(r,e){return Cr(e)||qe("changeType"),Object.keys(e).some(function(s){return!vu(r,s)})&&qe("changeField"),e}function ju(r){Wt(r)||qe("selectorType")}function Nu(r){Wt(r)||Cr(r)||qe("handlerType"),Cr(r)&&Object.values(r).some(function(e){return!Wt(e)})&&qe("handlersType")}function Su(r){r||qe("initialIsRequired"),Cr(r)||qe("initialType"),yu(r)&&qe("initialContent")}function Cu(r,e){throw new Error(r[e]||r.default)}var ku={initialIsRequired:"initial state is required",initialType:"initial state should be an object",initialContent:"initial state shouldn't be an empty object",handlerType:"handler should be an object or a function",handlersType:"all handlers should be a functions",selectorType:"selector should be a function",changeType:"provided value of changes should be an object",changeField:'it seams you want to change a field in the state which is not specified in the "initial" state',default:"an unknown error accured in `state-local` package"},qe=_t(Cu)(ku),nr={changes:wu,selector:ju,handler:Nu,initial:Su};function Tu(r){var e=arguments.length>1&&arguments[1]!==void 0?arguments[1]:{};nr.initial(r),nr.handler(e);var s={current:r},n=_t(Au)(s,e),o=_t(Eu)(s),i=_t(nr.changes)(r),a=_t(Du)(s);function l(){var c=arguments.length>0&&arguments[0]!==void 0?arguments[0]:function(u){return u};return nr.selector(c),c(s.current)}function d(c){bu(n,o,i,a)(c)}return[l,d]}function Du(r,e){return Wt(e)?e(r.current):e}function Eu(r,e){return r.current=Fn(Fn({},r.current),e),e}function Au(r,e,s){return Wt(e)?e(r.current):Object.keys(s).forEach(function(n){var o;return(o=e[n])===null||o===void 0?void 0:o.call(e,r.current[n])}),s}var Pu={create:Tu},Ru={paths:{vs:"https://cdn.jsdelivr.net/npm/monaco-editor@0.52.2/min/vs"}};function Ou(r){return function e(){for(var s=this,n=arguments.length,o=new Array(n),i=0;i<n;i++)o[i]=arguments[i];return o.length>=r.length?r.apply(this,o):function(){for(var a=arguments.length,l=new Array(a),d=0;d<a;d++)l[d]=arguments[d];return e.apply(s,[].concat(o,l))}}}function Iu(r){return{}.toString.call(r).includes("Object")}function Mu(r){return r||_n("configIsRequired"),Iu(r)||_n("configType"),r.urls?(Lu(),{paths:{vs:r.urls.monacoBase}}):r}function Lu(){console.warn(hi.deprecation)}function Fu(r,e){throw new Error(r[e]||r.default)}var hi={configIsRequired:"the configuration object is required",configType:"the configuration object should be an object",default:"an unknown error accured in `@monaco-editor/loader` package",deprecation:`Deprecation warning!
  ...
  `},_n=Ou(Fu)(hi),_u={config:Mu},$u=function(){for(var e=arguments.length,s=new Array(e),n=0;n<e;n++)s[n]=arguments[n];return function(o){return s.reduceRight(function(i,a){return a(i)},o)}};function fi(r,e){return Object.keys(e).forEach(function(s){e[s]instanceof Object&&r[s]&&Object.assign(e[s],fi(r[s],e[s]))}),In(In({},r),e)}var Bu={type:"cancelation",msg:"operation is manually canceled"};function rs(r){var e=!1,s=new Promise(function(n,o){r.then(function(i){return e?o(Bu):n(i)}),r.catch(o)});return s.cancel=function(){return e=!0},s}var Uu=Pu.create({config:Ru,isInitialized:!1,resolve:null,reject:null,monaco:null}),gi=mu(Uu,2),Jt=gi[0],Fr=gi[1];function Hu(r){var e=_u.config(r),s=e.monaco,n=uu(e,["monaco"]);Fr(function(o){return{config:fi(o.config,n),monaco:s}})}function zu(){var r=Jt(function(e){var s=e.monaco,n=e.isInitialized,o=e.resolve;return{monaco:s,isInitialized:n,resolve:o}});if(!r.isInitialized){if(Fr({isInitialized:!0}),r.monaco)return r.resolve(r.monaco),rs(ss);if(window.monaco&&window.monaco.editor)return xi(window.monaco),r.resolve(window.monaco),rs(ss);$u(Gu,Wu)(Vu)}return rs(ss)}function Gu(r){return document.body.appendChild(r)}function qu(r){var e=document.createElement("script");return r&&(e.src=r),e}function Wu(r){var e=Jt(function(n){var o=n.config,i=n.reject;return{config:o,reject:i}}),s=qu("".concat(e.config.paths.vs,"/loader.js"));return s.onload=function(){return r()},s.onerror=e.reject,s}function Vu(){var r=Jt(function(s){var n=s.config,o=s.resolve,i=s.reject;return{config:n,resolve:o,reject:i}}),e=window.require;e.config(r.config),e(["vs/editor/editor.main"],function(s){xi(s),r.resolve(s)},function(s){r.reject(s)})}function xi(r){Jt().monaco||Fr({monaco:r})}function Ju(){return Jt(function(r){var e=r.monaco;return e})}var ss=new Promise(function(r,e){return Fr({resolve:r,reject:e})}),bi={config:Hu,init:zu,__getMonacoInstance:Ju},Ku={wrapper:{display:"flex",position:"relative",textAlign:"initial"},fullWidth:{width:"100%"},hide:{display:"none"}},ns=Ku,Yu={container:{display:"flex",height:"100%",width:"100%",justifyContent:"center",alignItems:"center"}},Xu=Yu;function Qu({children:r}){return De.createElement("div",{style:Xu.container},r)}var Zu=Qu,em=Zu;function tm({width:r,height:e,isEditorReady:s,loading:n,_ref:o,className:i,wrapperProps:a}){return De.createElement("section",{style:{...ns.wrapper,width:r,height:e},...a},!s&&De.createElement(em,null,n),De.createElement("div",{ref:o,style:{...ns.fullWidth,...!s&&ns.hide},className:i}))}var rm=tm,yi=p.memo(rm);function sm(r){p.useEffect(r,[])}var vi=sm;function nm(r,e,s=!0){let n=p.useRef(!0);p.useEffect(n.current||!s?()=>{n.current=!1}:r,e)}var xe=nm;function Bt(){}function bt(r,e,s,n){return om(r,n)||im(r,e,s,n)}function om(r,e){return r.editor.getModel(wi(r,e))}function im(r,e,s,n){return r.editor.createModel(e,s,n?wi(r,n):void 0)}function wi(r,e){return r.Uri.parse(e)}function am({original:r,modified:e,language:s,originalLanguage:n,modifiedLanguage:o,originalModelPath:i,modifiedModelPath:a,keepCurrentOriginalModel:l=!1,keepCurrentModifiedModel:d=!1,theme:c="light",loading:u="Loading...",options:m={},height:x="100%",width:v="100%",className:g,wrapperProps:f={},beforeMount:h=Bt,onMount:C=Bt}){let[b,j]=p.useState(!1),[w,y]=p.useState(!0),D=p.useRef(null),A=p.useRef(null),I=p.useRef(null),F=p.useRef(C),N=p.useRef(h),E=p.useRef(!1);vi(()=>{let P=bi.init();return P.then(L=>(A.current=L)&&y(!1)).catch(L=>(L==null?void 0:L.type)!=="cancelation"&&console.error("Monaco initialization: error:",L)),()=>D.current?T():P.cancel()}),xe(()=>{if(D.current&&A.current){let P=D.current.getOriginalEditor(),L=bt(A.current,r||"",n||s||"text",i||"");L!==P.getModel()&&P.setModel(L)}},[i],b),xe(()=>{if(D.current&&A.current){let P=D.current.getModifiedEditor(),L=bt(A.current,e||"",o||s||"text",a||"");L!==P.getModel()&&P.setModel(L)}},[a],b),xe(()=>{let P=D.current.getModifiedEditor();P.getOption(A.current.editor.EditorOption.readOnly)?P.setValue(e||""):e!==P.getValue()&&(P.executeEdits("",[{range:P.getModel().getFullModelRange(),text:e||"",forceMoveMarkers:!0}]),P.pushUndoStop())},[e],b),xe(()=>{var P,L;(L=(P=D.current)==null?void 0:P.getModel())==null||L.original.setValue(r||"")},[r],b),xe(()=>{let{original:P,modified:L}=D.current.getModel();A.current.editor.setModelLanguage(P,n||s||"text"),A.current.editor.setModelLanguage(L,o||s||"text")},[s,n,o],b),xe(()=>{var P;(P=A.current)==null||P.editor.setTheme(c)},[c],b),xe(()=>{var P;(P=D.current)==null||P.updateOptions(m)},[m],b);let z=p.useCallback(()=>{var W;if(!A.current)return;N.current(A.current);let P=bt(A.current,r||"",n||s||"text",i||""),L=bt(A.current,e||"",o||s||"text",a||"");(W=D.current)==null||W.setModel({original:P,modified:L})},[s,e,o,r,n,i,a]),$=p.useCallback(()=>{var P;!E.current&&I.current&&(D.current=A.current.editor.createDiffEditor(I.current,{automaticLayout:!0,...m}),z(),(P=A.current)==null||P.editor.setTheme(c),j(!0),E.current=!0)},[m,c,z]);p.useEffect(()=>{b&&F.current(D.current,A.current)},[b]),p.useEffect(()=>{!w&&!b&&$()},[w,b,$]);function T(){var L,W,q,le;let P=(L=D.current)==null?void 0:L.getModel();l||((W=P==null?void 0:P.original)==null||W.dispose()),d||((q=P==null?void 0:P.modified)==null||q.dispose()),(le=D.current)==null||le.dispose()}return De.createElement(yi,{width:v,height:x,isEditorReady:b,loading:u,_ref:I,className:g,wrapperProps:f})}var lm=am;p.memo(lm);function cm(r){let e=p.useRef();return p.useEffect(()=>{e.current=r},[r]),e.current}var dm=cm,or=new Map;function um({defaultValue:r,defaultLanguage:e,defaultPath:s,value:n,language:o,path:i,theme:a="light",line:l,loading:d="Loading...",options:c={},overrideServices:u={},saveViewState:m=!0,keepCurrentModel:x=!1,width:v="100%",height:g="100%",className:f,wrapperProps:h={},beforeMount:C=Bt,onMount:b=Bt,onChange:j,onValidate:w=Bt}){let[y,D]=p.useState(!1),[A,I]=p.useState(!0),F=p.useRef(null),N=p.useRef(null),E=p.useRef(null),z=p.useRef(b),$=p.useRef(C),T=p.useRef(),P=p.useRef(n),L=dm(i),W=p.useRef(!1),q=p.useRef(!1);vi(()=>{let B=bi.init();return B.then(G=>(F.current=G)&&I(!1)).catch(G=>(G==null?void 0:G.type)!=="cancelation"&&console.error("Monaco initialization: error:",G)),()=>N.current?ge():B.cancel()}),xe(()=>{var G,J,ne,oe;let B=bt(F.current,r||n||"",e||o||"",i||s||"");B!==((G=N.current)==null?void 0:G.getModel())&&(m&&or.set(L,(J=N.current)==null?void 0:J.saveViewState()),(ne=N.current)==null||ne.setModel(B),m&&((oe=N.current)==null||oe.restoreViewState(or.get(i))))},[i],y),xe(()=>{var B;(B=N.current)==null||B.updateOptions(c)},[c],y),xe(()=>{!N.current||n===void 0||(N.current.getOption(F.current.editor.EditorOption.readOnly)?N.current.setValue(n):n!==N.current.getValue()&&(q.current=!0,N.current.executeEdits("",[{range:N.current.getModel().getFullModelRange(),text:n,forceMoveMarkers:!0}]),N.current.pushUndoStop(),q.current=!1))},[n],y),xe(()=>{var G,J;let B=(G=N.current)==null?void 0:G.getModel();B&&o&&((J=F.current)==null||J.editor.setModelLanguage(B,o))},[o],y),xe(()=>{var B;l!==void 0&&((B=N.current)==null||B.revealLine(l))},[l],y),xe(()=>{var B;(B=F.current)==null||B.editor.setTheme(a)},[a],y);let le=p.useCallback(()=>{var B;if(!(!E.current||!F.current)&&!W.current){$.current(F.current);let G=i||s,J=bt(F.current,n||r||"",e||o||"",G||"");N.current=(B=F.current)==null?void 0:B.editor.create(E.current,{model:J,automaticLayout:!0,...c},u),m&&N.current.restoreViewState(or.get(G)),F.current.editor.setTheme(a),l!==void 0&&N.current.revealLine(l),D(!0),W.current=!0}},[r,e,s,n,o,i,c,u,m,a,l]);p.useEffect(()=>{y&&z.current(N.current,F.current)},[y]),p.useEffect(()=>{!A&&!y&&le()},[A,y,le]),P.current=n,p.useEffect(()=>{var B,G;y&&j&&((B=T.current)==null||B.dispose(),T.current=(G=N.current)==null?void 0:G.onDidChangeModelContent(J=>{q.current||j(N.current.getValue(),J)}))},[y,j]),p.useEffect(()=>{if(y){let B=F.current.editor.onDidChangeMarkers(G=>{var ne;let J=(ne=N.current.getModel())==null?void 0:ne.uri;if(J&&G.find(oe=>oe.path===J.path)){let oe=F.current.editor.getModelMarkers({resource:J});w==null||w(oe)}});return()=>{B==null||B.dispose()}}return()=>{}},[y,w]);function ge(){var B,G;(B=T.current)==null||B.dispose(),x?m&&or.set(i,N.current.saveViewState()):(G=N.current.getModel())==null||G.dispose(),N.current.dispose()}return De.createElement(yi,{width:v,height:g,isEditorReady:y,loading:d,_ref:E,className:f,wrapperProps:h})}var mm=um,pm=p.memo(mm);const hm=()=>{var b,j,w,y,D,A;const{theme:r}=Lr(),{currentProject:e,updateFile:s}=Le(),[n,o]=p.useState(!0),[i,a]=p.useState(null),l=p.useRef(null);p.useEffect(()=>{if(l.current){const I=e.files[e.activeFile]||"",F=l.current.getValue();I!==F&&l.current.setValue(I)}},[e.activeFile,e.files[e.activeFile]]),p.useEffect(()=>{const I=()=>{l.current&&setTimeout(()=>{l.current.layout()},100)};return window.addEventListener("resize",I),()=>window.removeEventListener("resize",I)},[]);const d=(I,F)=>{try{console.log("🎯 Monaco Editor mounting..."),o(!1),a(null),l.current=I;const N=e.files[e.activeFile]||"";N&&I.setValue(N),F.editor.defineTheme("custom-dark",{base:"vs-dark",inherit:!0,rules:[{token:"comment",foreground:"6A9955"},{token:"keyword",foreground:"569CD6"},{token:"string",foreground:"CE9178"},{token:"number",foreground:"B5CEA8"},{token:"tag",foreground:"569CD6"},{token:"attribute.name",foreground:"92C5F8"},{token:"attribute.value",foreground:"CE9178"}],colors:{"editor.background":"#1e1e1e","editor.foreground":"#d4d4d4","editor.lineHighlightBackground":"#2a2d2e","editor.selectionBackground":"#264f78","editor.inactiveSelectionBackground":"#3a3d41"}}),F.editor.defineTheme("custom-light",{base:"vs",inherit:!0,rules:[{token:"comment",foreground:"6A9955"},{token:"keyword",foreground:"0000FF"},{token:"string",foreground:"A31515"},{token:"number",foreground:"098658"},{token:"tag",foreground:"800000"},{token:"attribute.name",foreground:"FF0000"},{token:"attribute.value",foreground:"0451A5"}],colors:{"editor.background":"#ffffff","editor.foreground":"#000000","editor.lineHighlightBackground":"#f5f5f5","editor.selectionBackground":"#add6ff","editor.inactiveSelectionBackground":"#e5ebf1"}}),F.editor.setTheme(r==="dark"?"custom-dark":"custom-light"),I.updateOptions({fontSize:14,fontFamily:"JetBrains Mono, Monaco, Consolas, monospace",lineHeight:22,minimap:{enabled:!0},scrollBeyondLastLine:!1,automaticLayout:!0,wordWrap:"on",formatOnPaste:!0,formatOnType:!0,suggestOnTriggerCharacters:!0,acceptSuggestionOnEnter:"on",tabCompletion:"on",wrappingIndent:"indent",lineNumbers:"on",glyphMargin:!0,folding:!0,foldingStrategy:"indentation",showFoldingControls:"always"}),setTimeout(()=>{I.layout()},100);try{I.addCommand(F.KeyMod.CtrlCmd|F.KeyCode.KeyS,()=>{g()}),I.addCommand(F.KeyMod.CtrlCmd|F.KeyCode.KeyC,()=>{I.getSelection().isEmpty()&&x()})}catch(E){console.warn("⚠️ Could not add keyboard shortcuts:",E)}}catch(N){console.error("❌ Error mounting Monaco Editor:",N),console.error("❌ Monaco Editor error details:",N.message,N.stack),a(N.message),o(!1),_.error("Failed to load code editor")}},c=I=>{try{I!==void 0&&s(e.activeFile,I)}catch(F){console.error("Error updating file:",F),_.error("Failed to save changes")}},u=()=>{const I=e.activeFile.split(".").pop();return{html:"html",css:"css",js:"javascript",jsx:"javascript",ts:"typescript",tsx:"typescript",py:"python",java:"java",cpp:"cpp",c:"c",php:"php",rb:"ruby",go:"go",rs:"rust",swift:"swift",kt:"kotlin",scala:"scala",clj:"clojure",hs:"haskell",ml:"fsharp",fs:"fsharp",vb:"vb",sql:"sql",json:"json",xml:"xml",yaml:"yaml",yml:"yaml",md:"markdown",sh:"shell",bash:"shell",ps1:"powershell",dockerfile:"dockerfile"}[I]||"plaintext"},m=()=>{const I=e.files[e.activeFile]||"";navigator.clipboard.writeText(I),_.success("Code copied to clipboard!")},x=()=>{const I=e.files[e.activeFile]||"";navigator.clipboard.writeText(I),_.success("All code copied to clipboard!")},v=()=>{const I=e.files[e.activeFile]||"",F=new Blob([I],{type:"text/plain"}),N=URL.createObjectURL(F),E=document.createElement("a");E.href=N,E.download=e.activeFile,document.body.appendChild(E),E.click(),document.body.removeChild(E),URL.revokeObjectURL(N),_.success(`Downloaded ${e.activeFile}`)},g=()=>{_.success("Code saved!")},f=()=>{l.current&&(l.current.getAction("editor.action.formatDocument").run(),_.success("Code formatted!"))},h={"index.html":"🌐","style.css":"🎨","script.js":"⚡","components.jsx":"🧩","package.json":"📦","README.md":"📖"},C=I=>h[I]||"📄";return t.jsxs(R.div,{initial:{opacity:0,y:20},animate:{opacity:1,y:0},className:"h-full flex flex-col bg-card border border-border rounded-lg overflow-hidden",children:[t.jsxs("div",{className:"flex items-center justify-between p-3 border-b border-border bg-muted/50",children:[t.jsxs("div",{className:"flex items-center gap-2",children:[t.jsx("span",{className:"text-lg",children:C(e.activeFile)}),t.jsx("span",{className:"font-medium text-sm",children:e.activeFile}),t.jsx("span",{className:"text-xs text-muted-foreground bg-muted px-2 py-1 rounded",children:u()})]}),t.jsxs("div",{className:"flex items-center gap-2",children:[t.jsx("button",{onClick:f,className:"p-2 hover:bg-muted rounded-md transition-colors",title:"Format Code (Ctrl+Shift+F)",children:t.jsx(Dr,{className:"h-4 w-4"})}),t.jsx("button",{onClick:m,className:"p-2 hover:bg-muted rounded-md transition-colors",title:"Copy Code",children:t.jsx(jt,{className:"h-4 w-4"})}),t.jsx("button",{onClick:v,className:"p-2 hover:bg-muted rounded-md transition-colors",title:"Download File",children:t.jsx(We,{className:"h-4 w-4"})})]})]}),t.jsx("div",{className:"flex-1 relative h-full min-h-[500px]",children:i?t.jsxs("div",{className:"flex flex-col items-center justify-center h-full text-center p-8",children:[t.jsx("div",{className:"text-red-500 text-lg mb-4",children:"⚠️ Editor Error"}),t.jsx("div",{className:"text-muted-foreground mb-4",children:i}),t.jsx("button",{onClick:()=>{a(null),o(!0),window.location.reload()},className:"px-4 py-2 bg-primary text-primary-foreground rounded-md hover:bg-primary/90",children:"Reload Editor"})]}):t.jsx(pm,{height:"100%",language:u(),value:e.files[e.activeFile]||"",onChange:c,onMount:d,theme:r==="dark"?"vs-dark":"vs",loading:t.jsxs("div",{className:"flex items-center justify-center h-full",children:[t.jsx("div",{className:"animate-spin rounded-full h-8 w-8 border-b-2 border-primary"}),t.jsx("span",{className:"ml-2",children:"Loading editor..."})]}),options:{selectOnLineNumbers:!0,roundedSelection:!1,readOnly:!1,cursorStyle:"line",automaticLayout:!0,mouseWheelZoom:!0,smoothScrolling:!0,cursorBlinking:"blink",renderLineHighlight:"line",renderWhitespace:"selection",renderIndentGuides:!0,highlightActiveIndentGuide:!0,bracketPairColorization:{enabled:!0},guides:{bracketPairs:!0,indentation:!0},scrollBeyondLastLine:!1,wordWrap:"on",wrappingIndent:"indent",lineNumbers:"on",glyphMargin:!0,folding:!0,foldingStrategy:"indentation",showFoldingControls:"always",unfoldOnClickAfterEnd:!1,contextmenu:!0,mouseWheelScrollSensitivity:1,fastScrollSensitivity:5,cursorSurroundingLines:3,cursorSurroundingLinesStyle:"default",scrollbar:{vertical:"auto",horizontal:"auto",verticalScrollbarSize:14,horizontalScrollbarSize:14,useShadows:!0,verticalHasArrows:!1,horizontalHasArrows:!1,arrowSize:11,verticalSliderSize:14,horizontalSliderSize:14}}},`${e.activeFile}-${((b=e.files[e.activeFile])==null?void 0:b.length)||0}`)}),t.jsxs("div",{className:"flex items-center justify-between p-2 border-t border-border bg-muted/30 text-xs text-muted-foreground",children:[t.jsxs("div",{className:"flex items-center gap-4",children:[t.jsxs("span",{children:["Line ",((w=(j=l.current)==null?void 0:j.getPosition())==null?void 0:w.lineNumber)||1]}),t.jsxs("span",{children:["Column ",((D=(y=l.current)==null?void 0:y.getPosition())==null?void 0:D.column)||1]}),t.jsxs("span",{children:[((A=e.files[e.activeFile])==null?void 0:A.length)||0," characters"]})]}),t.jsxs("div",{className:"flex items-center gap-2",children:[t.jsx("span",{children:"Ctrl+S to save"}),t.jsx("span",{children:"•"}),t.jsx("span",{children:"Ctrl+C to copy all"})]})]})]})},fm=()=>{console.log("🎮 Preview component rendered!");const{currentProject:r}=Le(),e=p.useRef(null),[s,n]=p.useState(!1),[o,i]=p.useState(!1),[a,l]=p.useState(null),[d,c]=p.useState(0);De.useEffect(()=>{c(b=>b+1),console.log("🎮 Preview component rendered! Render count:",d+1)},[]),p.useEffect(()=>{console.log("🎮 Preview useEffect triggered - files changed:",Object.keys(r.files)),console.log("🎮 Preview useEffect - currentProject:",r),console.log("🎮 Preview useEffect - file count:",Object.keys(r.files).length);const b=setTimeout(()=>{u()},50);return()=>clearTimeout(b)},[r.files,r.activeFile,r]),p.useEffect(()=>{const b=()=>{e.current?(console.log("🎮 Iframe mounted, updating preview..."),u()):(console.log("🎮 Iframe not ready, retrying..."),setTimeout(b,50))};setTimeout(b,100)},[]);const u=()=>{if(console.log("🎮 updatePreview called with files:",Object.keys(r.files)),!e.current){console.log("🎮 updatePreview: iframeRef.current is null, skipping update");return}if(!r.files||Object.keys(r.files).length===0){console.log("🎮 updatePreview: No files to display, showing placeholder"),v();return}console.log("🎮 updatePreview: iframeRef.current exists, proceeding..."),n(!0),l(null);try{let b=r.files["index.html"]||"";if(!b.trim()){const $=Object.keys(r.files).filter(T=>T.endsWith(".html")&&T!=="index.html");if($.length>0){console.log("🎮 Preview Debug - No index.html found, using:",$[0]);const T=r.files[$[0]]||"";T.trim()&&(b=T)}}const j=Object.keys(r.files).filter($=>$.endsWith(".css")),w=j.map($=>r.files[$]).join(`
`);console.log("🎮 Preview Debug - All CSS files found:",j),console.log("🎮 Preview Debug - CSS content length:",w.length),console.log("🎮 Preview Debug - CSS content preview:",w.substring(0,200)+"...");const y=r.files["script.js"]||"",D=r.files["src/components/GameApp.jsx"]||"",A=r.files["src/components/GameComponent.jsx"]||"",I=r.files["src/components/TempleRunUI.jsx"]||"",F=r.files["src/components/RunnerPlayer.jsx"]||"",N=r.files["src/components/Obstacle.jsx"]||"";if(A&&(console.log("🎮 Preview Debug - GameComponent content preview:",A.substring(0,200)+"..."),console.log("🎮 Preview Debug - GameComponent contains Temple Run:",A.toLowerCase().includes("temple run")),console.log("🎮 Preview Debug - GameComponent contains lane:",A.toLowerCase().includes("lane")),console.log("🎮 Preview Debug - GameComponent contains jump:",A.toLowerCase().includes("jump"))),console.log("🎮 Preview Debug - Checking for game files:"),console.log("🎮 - GameApp.jsx exists:",!!D),console.log("🎮 - GameComponent.jsx exists:",!!A),console.log("🎮 - TempleRunUI.jsx exists:",!!I),console.log("🎮 - RunnerPlayer.jsx exists:",!!F),console.log("🎮 - Obstacle.jsx exists:",!!N),console.log("🎮 - All project files:",Object.keys(r.files)),D||A){console.log("🎮 Preview Debug - Game files detected, creating React preview"),console.log("🎮 Preview Debug - About to call createReactPreview, iframeRef.current:",!!e.current),x(),console.log("🎮 Preview Debug - createReactPreview call completed");return}if(console.log("🎮 Preview Debug - No game files detected, using regular HTML preview"),console.log("🎮 Preview Debug - HTML content length:",b.length),console.log("🎮 Preview Debug - CSS content length:",w.length),console.log("🎮 Preview Debug - JS content length:",y.length),!b.trim()){console.log("🎮 Preview Debug - No HTML content found, creating basic structure");const $=w.trim().length>0,T=y.trim().length>0;b=`<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
...
</html>`,console.log("🎮 Preview Debug - Created basic HTML structure")}let E=b;if(w.trim()&&(E=E.replace(/<link[^>]*rel=["']stylesheet["'][^>]*href=["']style\.css["'][^>]*>/gi,`<style>${w}</style>`),E===b&&E.includes("<head>")?E=E.replace("<head>",`<head>
<style>${w}</style>`):E===b&&!E.includes("<head>")&&(E.includes("<title>")?E=E.replace("</title>",`</title>
<style>${w}</style>`):E=`<style>${w}</style>
${E}`)),y.trim()){const $=`(function() {
          ${y}
        })();`;E=E.replace(/<script[^>]*src=["']script\.js["'][^>]*><\/script>/gi,`<script>${$}<\/script>`),E.includes("</body>")?E=E.replace("</body>",`<script>${$}<\/script>
</body>`):E+=`
<script>${$}<\/script>`}E.includes("<!DOCTYPE html>")||(E=`<!DOCTYPE html>
${E}`),console.log("🎮 Preview Debug - Final HTML length:",E.length),console.log("🎮 Preview Debug - HTML contains <style>:",E.includes("<style>")),console.log("🎮 Preview Debug - HTML contains <script>:",E.includes("<script>")),console.log("🎮 Preview Debug - HTML preview:",E.substring(0,500)+"...");const z=e.current;z.srcdoc=E,z.onload=()=>{n(!1),l(null)},z.onerror=()=>{n(!1),l("Failed to load preview")}}catch(b){console.error("Preview update error:",b),n(!1),l("Preview update failed")}},m=b=>b?b.replace(/`/g,"\\`").replace(/\${/g,"\\${").replace(/\$/g,"\\$"):"",x=()=>{if(console.log("🎮 Creating React preview..."),!e.current){console.log("🎮 createReactPreview: iframeRef.current is null");return}try{const b=r.files["src/components/GameApp.jsx"]||"",j=r.files["src/components/GameComponent.jsx"]||"",w=r.files["src/components/TempleRunUI.jsx"]||"",y=r.files["src/components/RunnerPlayer.jsx"]||"",D=r.files["src/components/Obstacle.jsx"]||"",A=r.files["src/components/Coin.jsx"]||"",I=r.files["src/components/Player.jsx"]||"",F=r.files["src/components/GameApp.css"]||"",N=r.files["src/components/GameComponent.css"]||"",E=r.files["src/components/TempleRunUI.css"]||"",z=r.files["src/components/RunnerPlayer.css"]||"",$=r.files["src/components/Obstacle.css"]||"",T=r.files["src/components/Coin.css"]||"",P=r.files["src/components/Player.css"]||"",L=w||y||D,W=I||A,q=j.toLowerCase(),le=q.includes("temple run")||q.includes("lane")||q.includes("jump")||q.includes("slide")||q.includes("obstacle")||q.includes("endless runner"),ge=L||le,B=W&&!ge;console.log("🎮 Preview Debug - Available files:"),console.log("🎮 - templeRunUIFile:",!!w),console.log("🎮 - runnerPlayerFile:",!!y),console.log("🎮 - obstacleFile:",!!D),console.log("🎮 - playerFile:",!!I),console.log("🎮 - coinFile:",!!A),console.log("🎮 - hasTempleRunFiles:",L),console.log("🎮 - hasTempleRunContent:",le),console.log("🎮 - isTempleRun:",ge),console.log("🎮 - isCoinCollector:",B),console.log("🎮 - All project files:",Object.keys(r.files)),console.log("🎮 FINAL GAME TYPE DECISION:"),console.log(ge?"🎮 ✅ RENDERING TEMPLE RUN GAME":B?"🎮 ✅ RENDERING COIN COLLECTOR GAME":"🎮 ✅ RENDERING DEFAULT GAME");const G=`
      <!DOCTYPE html>
      <html lang="en">
      <head>
        <meta charset="UTF-8">
...
${L}`},j=(T,P)=>{const L=P.getDropResult();if(!L)return;const W={id:`component-${Date.now()}`,type:T.type,name:T.name,position:{x:L.x,y:L.y},size:{width:200,height:100},styles:{position:"absolute",left:`${L.x}px`,top:`${L.y}px`,width:"200px",height:"100px",border:"1px solid #ddd",padding:"10px",backgroundColor:"#fff"},content:T.name,properties:{}};o(q=>[...q,W])},w=T=>{a(T),d(!0)},y=(T,P)=>{if(!i)return;const L={...i,[T]:P,styles:{...i.styles,[T]:P}};o(W=>W.map(q=>q.id===i.id?L:q)),a(L)},D=()=>`
.app {
  position: relative;
  width: 100%;
  min-height: 100vh;

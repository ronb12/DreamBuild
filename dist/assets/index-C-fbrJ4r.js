import{r as p,a as aa,b as la,R as Ee,g as ca}from"./react-vendor-DWvC8KHc.js";import{_ as da,C as ua,r as mn,S as ma,F as pa,g as ps,a as Cr,b as ha,c as fa,d as ga,i as gr,e as Fs,f as _s,o as $s,h as ir,j as J,s as xa,G as ba,k as ya,l as ve,u as Yt,m as At,n as de,q as ye,w as ue,p as Pt,t as Le,v as Jr,x as ar,y as va,z as Rt}from"./firebase-C3tU7F8Z.js";import{_ as tt}from"./monaco-editor-BWpThiUx.js";import{S as yt,R as je,C as X,D as bt,U as hs,M as wa,a as ja,b as fs,L as pn,X as Na,c as Sa,G as Ie,T as Bs,d as xr,e as Us,m as O,f as go,Z as vt,F as ze,P as br,g as ft,h as xo,i as ot,j as Ca,k as bo,A as $e,l as Bt,n as wt,o as gs,p as yo,q as zs,E as yr,r as ka,s as Ta,B as Kr,t as vr,u as Da,v as Ea,w as ke,x as qe,y as kr,z as Ae,H as Hs,I as Aa,J as it,K as jt,N as xs,O as Be,Q as vo,V as Pa,W as wo,Y as Ra,_ as jo,$ as Gs,a0 as Oa,a1 as Ia,a2 as Ma,a3 as Tr,a4 as gt,a5 as La,a6 as No,a7 as Fa,a8 as _a,a9 as $a,aa as lr,ab as Ba,ac as Yr,ad as hn,ae as bs,af as ys,ag as vs,ah as Ua,ai as za,aj as Ha,ak as Ga}from"./ui-vendor-B6P2j6a_.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))n(o);new MutationObserver(o=>{for(const i of o)if(i.type==="childList")for(const a of i.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&n(a)}).observe(document,{childList:!0,subtree:!0});function s(o){const i={};return o.integrity&&(i.integrity=o.integrity),o.referrerPolicy&&(i.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?i.credentials="include":o.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function n(o){if(o.ep)return;o.ep=!0;const i=s(o);fetch(o.href,i)}})();var So={exports:{}},Dr={};/**
 * @license React
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Zs(r,e,s){let n=e;return s==null&&(n=`https://${e}`),`${s}://${n}/v0${r}`}function Jo(r){const e=encodeURIComponent;let s="?";for(const n in r)if(r.hasOwnProperty(n)){const o=e(n)+"="+e(r[n]);s=s+o+"&"}return s=s.slice(0,-1),s}var st;(function(r){r[r.NO_ERROR=0]="NO_ERROR",r[r.NETWORK_ERROR=1]="NETWORK_ERROR",r[r.ABORT=2]="ABORT"})(st||(st={}));/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class _e{constructor(e,s){let n=0,o="";kn(e)?(this.data_=e,n=e.size,o=e.type):e instanceof ArrayBuffer?(s?this.data_=new Uint8Array(e):(this.data_=new Uint8Array(e.byteLength),this.data_.set(new Uint8Array(e))),n=this.data_.length):e instanceof Uint8Array&&(s?this.data_=e:(this.data_=new Uint8Array(e.length),this.data_.set(e)),n=e.length),this.size_=n,this.type_=o}size(){return this.size_}type(){return this.type_}slice(e,s){if(kn(this.data_)){const n=this.data_,o=bd(n,e,s);return o===null?null:new _e(o)}else{const n=new Uint8Array(this.data_.buffer,e,s-e);return new _e(n,!0)}}static getBlob(...e){if(Qs()){const s=e.map(n=>n instanceof _e?n.data_:n);return new _e(xd.apply(null,s))}else{const s=e.map(a=>Xs(a)?vd(De.RAW,a).data:a.data_);let n=0;s.forEach(a=>{n+=a.byteLength});const o=new Uint8Array(n);let i=0;return s.forEach(a=>{for(let l=0;l<a.length;l++)o[i++]=a[l]}),new _e(o,!0)}}uploadData(){return this.data_}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function si(r){if(!r)throw Ys()}function Od(r,e){function s(n,o){const i=ti(r,o,e);return si(i!==null),i}return s}function Id(r,e){function s(n,o){const i=ti(r,o,e);return si(i!==null),Pd(i,o,r.host,r._protocol)}return s}function ni(r){function e(s,n){let o;return s.getStatus()===401?s.getErrorText().includes("Firebase App Check token is invalid")?o=Vc():o=Wc():s.getStatus()===402?o=qc(r.bucket):s.getStatus()===403?o=Jc(r.path):o=n,o.status=s.getStatus(),o.serverResponse=n.serverResponse,o}return e}function Md(r){const e=ni(r);function s(n,o){let i=e(n,o);return n.getStatus()===404&&(i=Gc(r.path)),i.serverResponse=o.serverResponse,i}return s}function Ld(r,e,s){const n=e.fullServerUrl(),o=Zs(n,r.host,r._protocol),i="GET",a=r.maxOperationRetryTime,l=new ri(o,i,Id(r,s),a);return l.errorHandler=Md(e),l}function Fd(r,e){return r&&r.contentType||e&&e.type()||"application/octet-stream"}function _d(r,e,s){const n=Object.assign({},s);return n.fullPath=r.path,n.size=e.size(),n.contentType||(n.contentType=Fd(null,e)),n}function $d(r,e,s,n,o){const i=e.bucketOnlyServerUrl(),a={"X-Goog-Upload-Protocol":"multipart"};function l(){let v="";for(let y=0;y<2;y++)v=v+Math.random().toString().slice(2);return v}const c=l();a["Content-Type"]="multipart/related; boundary="+c;const d=_d(e,n,o),m=Rd(d,s),u="--"+c+`\r

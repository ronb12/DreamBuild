import{initializeApp as wo}from"https://www.gstatic.com/firebasejs/10.14.1/firebase-app.js";import{getAuth as No,signInWithPopup as So,GithubAuthProvider as Co,GoogleAuthProvider as ko}from"https://www.gstatic.com/firebasejs/10.14.1/firebase-auth.js";import{r as m,a as To,b as Do,R as Me,g as Po}from"./react-vendor-DWvC8KHc.js";import{_ as Ao,C as Eo,r as va,S as Ro,F as Io,g as Cr,a as Fs,b as Oo,c as Lo,d as Mo,i as kr,e as Sn,f as Cn,o as kn,h as vs,j as se,s as Fo,G as $o,k as ja,l as je,m as _o,n as Bo,p as Uo,q as Ht,t as Gt,u as lt,w as wt,v as ir}from"./firebase-yUj2_25M.js";import{_ as _e}from"./monaco-editor-BWpThiUx.js";import{S as ft,R as Pe,C as J,B as me,D as Ae,U as He,M as Ho,a as Go,b as Ds,L as wa,X as Yr,c as zo,G as fe,T as Kr,d as Rt,e as Xr,m as M,f as $s,Z as Ge,F as Ie,P as It,g as Dt,h as Tn,i as tt,j as Wo,k as Dn,A as Ke,l as Qt,n as Ot,o as Pn,p as An,q as _s,E as Zt,r as qo,s as Vo,t as or,u as Ps,v as Jo,w as Yo,x as Ue,y as Ko,z as En,H as Xo,I as xe,J as pe,K as As,N as we,O as ze,Q as Bs,V as Se,W as es,Y as Qo,_ as ce,$ as Tr,a0 as Be,a1 as as,a2 as Zo,a3 as Rn,a4 as el,a5 as In,a6 as tl,a7 as On,a8 as sl,a9 as rl,aa as st,ab as al,ac as Pt,ad as Ln,ae as nl,af as Qr,ag as Dr,ah as lr,ai as Te,aj as Pr,ak as Ar,al as Er,am as il,an as ol,ao as ll,ap as cl,aq as dl,ar as Qe,as as We,at as Es,au as Zr,av as Mn,aw as ul,ax as cr,ay as ml,az as Rs,aA as pl,aB as hl,aC as gl,aD as fl,aE as xl,aF as bl,aG as yl}from"./ui-vendor-5a1Sn0ER.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))a(n);new MutationObserver(n=>{for(const i of n)if(i.type==="childList")for(const o of i.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&a(o)}).observe(document,{childList:!0,subtree:!0});function r(n){const i={};return n.integrity&&(i.integrity=n.integrity),n.referrerPolicy&&(i.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?i.credentials="include":n.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function a(n){if(n.ep)return;n.ep=!0;const i=r(n);fetch(n.href,i)}})();const vl={apiKey:"AIzaSyCWjBfZHPHDI4rXRStWPP48lRZVJquWH38",authDomain:"dreambuild-2024-app.firebaseapp.com",projectId:"dreambuild-2024-app",storageBucket:"dreambuild-2024-app.firebasestorage.app",messagingSenderId:"780467658601",appId:"1:780467658601:web:833a9373c15fa3be0be7f8"},Fn=wo(vl),jl=No(Fn);window.firebase={auth:()=>jl,GoogleAuthProvider:ko,GithubAuthProvider:Co,signInWithPopup:So};window.firebaseApp=Fn;console.log("Firebase loaded globally with providers:",!!window.firebase);var $n={exports:{}},Us={};/**
 * @license React
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class xt{constructor(t,r){this._service=t,r instanceof Ne?this._location=r:this._location=Ne.makeFromUrl(r,t.host)}toString(){return"gs://"+this._location.bucket+"/"+this._location.path}_newRef(t,r){return new xt(t,r)}get root(){const t=new Ne(this._location.bucket,"");return this._newRef(this._service,t)}get bucket(){return this._location.bucket}get fullPath(){return this._location.path}get name(){return pi(this._location.path)}get storage(){return this._service}get parent(){const t=su(this._location.path);if(t===null)return null;const r=new Ne(this._location.bucket,t);return new xt(this._service,r)}_throwIfRoot(t){if(this._location.path==="")throw Od(t)}}function yu(s,t,r){s._throwIfRoot("uploadBytes");const a=fu(s.storage,s._location,hi(),new Ye(t,!0),r);return s.storage.makeRequestWithTokens(a,yi).then(n=>({metadata:n,ref:s}))}function vu(s){s._throwIfRoot("getDownloadURL");const t=pu(s.storage,s._location,hi());return s.storage.makeRequestWithTokens(t,yi).then(r=>{if(r===null)throw Rd();return r})}function ju(s,t){const r=ru(s._location.path,t),a=new Ne(s._location.bucket,r);return new xt(s.storage,a)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
</html>`,K=(P,B)=>JSON.stringify({name:P.toLowerCase().replace(/[^a-z0-9-]/g,"-"),version:"1.0.0",description:`Built with DreamBuild - ${P}`,main:"index.html",scripts:{start:"npx serve .",build:"echo 'Static site - no build required'",deploy:"echo 'Deploy using DreamBuild deployment system'"},keywords:["dreambuild","ai-generated","web-app",B.appType||"frontend"],author:"DreamBuild AI",license:"MIT",engines:{node:">=14.0.0"},dependencies:{},devDependencies:{serve:"^14.0.0"}},null,2),oe=(P,B)=>{var _;return`# ${P}
...
${L}`),console.log("🎮 Preview Debug - Final HTML length:",L.length),console.log("🎮 Preview Debug - HTML contains <style>:",L.includes("<style>")),console.log("🎮 Preview Debug - HTML contains <script>:",L.includes("<script>")),console.log("🎮 Preview Debug - HTML preview:",L.substring(0,500)+"...");const A=t.current;A.srcdoc=L,A.onload=()=>{a(!1),l(null)},A.onerror=()=>{a(!1),l("Failed to load preview")}}catch(j){console.error("Preview update error:",j),a(!1),l("Preview update failed")}},p=j=>j?j.replace(/`/g,"\\`").replace(/\${/g,"\\${").replace(/\$/g,"\\$"):"",g=()=>{if(console.log("🎮 Creating React preview..."),!t.current){console.log("🎮 createReactPreview: iframeRef.current is null");return}try{const j=s.files["src/components/GameApp.jsx"]||"",w=s.files["src/components/GameComponent.jsx"]||"",v=s.files["src/components/TempleRunUI.jsx"]||"",f=s.files["src/components/RunnerPlayer.jsx"]||"",E=s.files["src/components/Obstacle.jsx"]||"",S=s.files["src/components/Coin.jsx"]||"",k=s.files["src/components/Player.jsx"]||"",D=s.files["src/components/GameApp.css"]||"",O=s.files["src/components/GameComponent.css"]||"",L=s.files["src/components/TempleRunUI.css"]||"",A=s.files["src/components/RunnerPlayer.css"]||"",$=s.files["src/components/Obstacle.css"]||"",T=s.files["src/components/Coin.css"]||"",C=s.files["src/components/Player.css"]||"",I=v||f||E,G=k||S,z=w.toLowerCase(),F=z.includes("temple run")||z.includes("lane")||z.includes("jump")||z.includes("slide")||z.includes("obstacle")||z.includes("endless runner"),W=I||F,H=G&&!W;console.log("🎮 Preview Debug - Available files:"),console.log("🎮 - templeRunUIFile:",!!v),console.log("🎮 - runnerPlayerFile:",!!f),console.log("🎮 - obstacleFile:",!!E),console.log("🎮 - playerFile:",!!k),console.log("🎮 - coinFile:",!!S),console.log("🎮 - hasTempleRunFiles:",I),console.log("🎮 - hasTempleRunContent:",F),console.log("🎮 - isTempleRun:",W),console.log("🎮 - isCoinCollector:",H),console.log("🎮 - All project files:",Object.keys(s.files)),console.log("🎮 FINAL GAME TYPE DECISION:"),console.log(W?"🎮 ✅ RENDERING TEMPLE RUN GAME":H?"🎮 ✅ RENDERING COIN COLLECTOR GAME":"🎮 ✅ RENDERING DEFAULT GAME");const q=`
      <!DOCTYPE html>
      <html lang="en">
      <head>
        <meta charset="UTF-8">

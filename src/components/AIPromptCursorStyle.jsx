...
export default function AIPromptCursorStyle() {
  ...
  return (
    <div className="h-full flex flex-col bg-background overflow-hidden">
      ...
      {showModelSelector && (
        <div className="fixed bottom-20 left-4 bg-background border border-border rounded-lg shadow-lg p-4 z-[999999] min-w-80 max-w-96 flex flex-col" style={{ height: '120px' }}>
          <div className="flex items-center justify-between mb-3">

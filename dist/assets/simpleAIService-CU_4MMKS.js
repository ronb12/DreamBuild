...
- Recent conversation: ${t.recentMessages?.slice(-3).map(a=>`${a.type}: ${a.content}`).join(`
`)||"none"}
- Project context: ${JSON.stringify(t.projectContext||{})}`:"";return`You are an expert software developer and code generator with advanced conversation capabilities. Generate complete, working applications based on user requests and maintain context across conversations.
...
- Frameworks: ${t.frameworks?.join(", ")||"vanilla"}${e}

...
`
  ...
  generateTetrisGame(prompt, appName = 'BlockMaster Pro') {
    return `// ${appName} - Generated by DreamBuild AI
// Product of Bradley Virtual Solutions, LLC
// AUTO-START TETRIS - No button needed!
console.log('🎮 Initializing ${appName}...')
...
class Tetris {
  constructor() {
    console.log('🎮 Tetris constructor called')
  ...
  initCanvas() {
    ...
    console.log('✅ Tetris initialized - Click canvas or press SPACE to start!')
  }
  ...
  setupControls() {
    ...
    console.log('✅ Controls ready! Click canvas or press SPACE to start')
  }
  ...
  drawGameOver() {
    ...
    this.ctx.fillText('Click or Press SPACE', this.canvas.width / 2, this.canvas.height / 2 + 60)
    this.ctx.fillText('to Play Again', this.canvas.width / 2, this.canvas.height / 2 + 85)
  }
...
console.log('🎮 AUTO-INIT Tetris starting...')

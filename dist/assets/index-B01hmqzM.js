import{r as p,a as aa,b as la,R as Ee,g as ca}from"./react-vendor-DWvC8KHc.js";import{_ as da,C as ua,r as un,S as ma,F as pa,g as ps,a as Cr,b as ha,c as fa,d as ga,i as gr,e as Ls,f as Fs,o as _s,h as ir,j as J,s as xa,G as ba,k as ya,l as ve,u as Yt,m as Et,n as de,q as ye,w as ue,p as At,t as Le,v as Jr,x as ar,y as va,z as Pt}from"./firebase-C3tU7F8Z.js";import{_ as tt}from"./monaco-editor-BWpThiUx.js";import{S as $t,R as je,C as X,D as bt,U as hs,M as wa,a as ja,b as fs,L as mn,X as Na,c as Sa,G as Ie,d as $s,e as Bs,H as xr,m as O,T as fo,Z as yt,F as ze,P as br,f as ft,g as go,h as ot,i as Ca,j as xo,A as $e,k as Bt,l as vt,n as gs,o as bo,p as Us,E as yr,q as ka,r as Ta,B as Kr,s as vr,t as Da,u as Ea,v as ke,w as qe,x as kr,y as Ae,z as zs,I as Aa,J as it,K as wt,N as xs,O as Be,Q as yo,V as Pa,W as vo,Y as Ra,_ as wo,$ as Hs,a0 as Oa,a1 as Ia,a2 as Ma,a3 as Tr,a4 as gt,a5 as La,a6 as jo,a7 as Fa,a8 as _a,a9 as $a,aa as lr,ab as Ba,ac as Yr,ad as pn,ae as bs,af as ys,ag as No,ah as Ua,ai as za,aj as Ha,ak as Ga}from"./ui-vendor--NkA-X99.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))n(o);new MutationObserver(o=>{for(const i of o)if(i.type==="childList")for(const a of i.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&n(a)}).observe(document,{childList:!0,subtree:!0});function s(o){const i={};return o.integrity&&(i.integrity=o.integrity),o.referrerPolicy&&(i.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?i.credentials="include":o.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function n(o){if(o.ep)return;o.ep=!0;const i=s(o);fetch(o.href,i)}})();var So={exports:{}},Dr={};/**
 * @license React
 ...
 *
 * @license MIT
 */function js(){return js=Object.assign?Object.assign.bind():function(r){for(var e=1;e<arguments.length;e++){var s=arguments[e];for(var n in s)Object.prototype.hasOwnProperty.call(s,n)&&(r[n]=s[n])}return r},js.apply(this,arguments)}function Hl(r,e){if(r==null)return{};var s={},n=Object.keys(r),o,i;for(i=0;i<n.length;i++)o=n[i],!(e.indexOf(o)>=0)&&(s[o]=r[o]);return s}function Gl(r){return!!(r.metaKey||r.altKey||r.ctrlKey||r.shiftKey)}function ql(r,e){return r.button===0&&(!e||e==="_self")&&!Gl(r)}const Wl=["onClick","relative","reloadDocument","replace","state","target","to","preventScrollReset","viewTransition"],Vl="6";try{window.__reactRouterVersion=Vl}catch{}const Jl="startTransition",vn=la[Jl];function Kl(r){let{basename:e,children:s,future:n,window:o}=r,i=p.useRef();i.current==null&&(i.current=Xa({window:o,v5Compat:!0}));let a=i.current,[l,c]=p.useState({action:a.action,location:a.location}),{v7_startTransition:d}=n||{},m=p.useCallback(u=>{d&&vn?vn(()=>c(u)):c(u)},[c,d]);return p.useLayoutEffect(()=>a.listen(m),[a,m]),p.useEffect(()=>$l(n),[n]),p.createElement(Ul,{basename:e,children:s,location:l.location,navigationType:l.action,navigator:a,future:n})}const Yl=typeof window<"u"&&typeof window.document<"u"&&typeof window.document.createElement<"u",Xl=/^(?:[a-z][a-z0-9+.-]*:|\/\/)/i,me=p.forwardRef(function(e,s){let{onClick:n,relative:o,reloadDocument:i,replace:a,state:l,target:c,to:d,preventScrollReset:m,viewTransition:u}=e,g=Hl(e,Wl),{basename:b}=p.useContext(We),f,j=!1;if(typeof d=="string"&&Xl.test(d)&&(f=d,Yl))try{let v=new URL(window.location.href),y=d.startsWith("//")?new URL(v.protocol+d):new URL(d),x=Gs(y.pathname,b);y.origin===v.origin&&x!=null?d=x+y.search+y.hash:j=!0}catch{}let h=Sl(d,{relative:o}),k=Ql(d,{replace:a,state:l,target:c,preventScrollReset:m,relative:o,viewTransition:u});function N(v){n&&n(v),v.defaultPrevented||k(v)}return p.createElement("a",js({},g,{href:f||h,onClick:j||i?n:N,ref:s,target:c}))});var wn;(function(r){r.UseScrollRestoration="useScrollRestoration",r.UseSubmit="useSubmit",r.UseSubmitFetcher="useSubmitFetcher",r.UseFetcher="useFetcher",r.useViewTransitionState="useViewTransitionState"})(wn||(wn={}));var jn;(function(r){r.UseFetcher="useFetcher",r.UseFetchers="useFetchers",r.UseScrollRestoration="useScrollRestoration"})(jn||(jn={}));function Ql(r,e){let{target:s,replace:n,state:o,preventScrollReset:i,relative:a,viewTransition:l}=e===void 0?{}:e,c=Ar(),d=Je(),m=Oo(r,{relative:a});return p.useCallback(u=>{if(ql(u,s)){u.preventDefault();let g=n!==void 0?n:wr(d)===wr(m);c(r,{replace:g,state:o,preventScrollReset:i,relative:a,viewTransition:l})}},[d,c,m,n,o,s,r,i,a,l])}let Zl={data:""},ec=r=>typeof window=="object"?((r?r.querySelector("#_goober"):window._goober)||Object.assign((r||document.head).appendChild(document.createElement("style")),{innerHTML:" ",id:"_goober"})).firstChild:r||Zl,tc=/(?:([\u0080-\uFFFF\w-%@]+) *:? *([^{;]+?);|([^;}{]*?) *{)|(}\s*)/g,rc=/\/\*[^]*?\*\/|  +/g,Nn=/\n+/g,Fe=(r,e)=>{let s="",n="",o="";for(let i in r){let a=r[i];i[0]=="@"?i[1]=="i"?s=i+" "+a+";":n+=i[1]=="f"?Fe(a,i):i+"{"+Fe(a,i[1]=="k"?"":e)+"}":typeof a=="object"?n+=Fe(a,e?e.replace(/([^,])+/g,l=>i.replace(/([^,]*:\S+\([^)]*\))|([^,])+/g,c=>/&/.test(c)?c.replace(/&/g,l):l?l+" "+c:c)):i):a!=null&&(i=/^--/.test(i)?i:i.replace(/[A-Z]/g,"-$&").toLowerCase(),o+=Fe.p?Fe.p(i,a):i+":"+a+";")}return s+(e&&o?e+"{"+o+"}":o)+n},Re={},Fo=r=>{if(typeof r=="object"){let e="";for(let s in r)e+=s+Fo(r[s]);return e}return r},sc=(r,e,s,n,o)=>{let i=Fo(r),a=Re[i]||(Re[i]=(c=>{let d=0,m=11;for(;d<c.length;)m=101*m+c.charCodeAt(d++)>>>0;return"go"+m})(i));if(!Re[a]){let c=i!==r?r:(d=>{let m,u,g=[{}];for(;m=tc.exec(d.replace(rc,""));)m[4]?g.shift():m[3]?(u=m[3].replace(Nn," ").trim(),g.unshift(g[0][u]=g[0][u]||{})):g[0][m[1]]=m[2].replace(Nn," ").trim();return g[0]})(r);Re[a]=Fe(o?{["@keyframes "+a]:c}:c,s?"":"."+a)}let l=s&&Re.g?Re.g:null;return s&&(Re.g=Re[a]),((c,d,m,u)=>{u?d.data=d.data.replace(u,c):d.data.indexOf(c)===-1&&(d.data=m?c+d.data:d.data+c)})(Re[a],e,n,l),a},nc=(r,e,s)=>r.reduce((n,o,i)=>{let a=e[i];if(a&&a.call){let l=a(s),c=l&&l.props&&l.props.className||/^go/.test(l)&&l;a=c?"."+c:l&&typeof l=="object"?l.props?"":Fe(l,""):l===!1?"":l}return n+o+(a??"")},"");function Pr(r){let e=this||{},s=r.call?r(e.p):r;return sc(s.unshift?s.raw?nc(s,[].slice.call(arguments,1),e.p):s.reduce((n,o)=>Object.assign(n,o&&o.call?o(e.p):o),{}):s,ec(e.target),e.g,e.o,e.k)}let _o,Ns,Ss;Pr.bind({g:1});let Me=Pr.bind({k:1});function oc(r,e,s,n){Fe.p=e,_o=r,Ns=s,Ss=n}function Ke(r,e){let s=this||{};return function(){let n=arguments;function o(i,a){let l=Object.assign({},i),c=l.className||o.className;s.p=Object.assign({theme:Ns&&Ns()},l),s.o=/ *go\d+/.test(c),l.className=Pr.apply(s,n)+(c?" "+c:"");let d=r;return r[0]&&(d=l.as||r,delete l.as),Ss&&d[0]&&Ss(l),_o(d,l)}return o}}var ic=r=>typeof r=="function",jr=(r,e)=>ic(r)?r(e):r,ac=(()=>{let r=0;return()=>(++r).toString()})(),$o=(()=>{let r;return()=>{if(r===void 0&&typeof window<"u"){let e=matchMedia("(prefers-reduced-motion: reduce)");r=!e||e.matches}return r}})(),lc=20,Js="default",Bo=(r,e)=>{let{toastLimit:s}=r.settings;switch(e.type){case 0:return{...r,toasts:[e.toast,...r.toasts].slice(0,s)};case 1:return{...r,toasts:r.toasts.map(a=>a.id===e.toast.id?{...a,...e.toast}:a)};case 2:let{toast:n}=e;return Bo(r,{type:r.toasts.find(a=>a.id===n.id)?1:0,toast:n});case 3:let{toastId:o}=e;return{...r,toasts:r.toasts.map(a=>a.id===o||o===void 0?{...a,dismissed:!0,visible:!1}:a)};case 4:return e.toastId===void 0?{...r,toasts:[]}:{...r,toasts:r.toasts.filter(a=>a.id!==e.toastId)};case 5:return{...r,pausedAt:e.time};case 6:let i=e.time-(r.pausedAt||0);return{...r,pausedAt:void 0,toasts:r.toasts.map(a=>({...a,pauseDuration:a.pauseDuration+i}))}}},cr=[],Uo={toasts:[],pausedAt:void 0,settings:{toastLimit:lc}},Te={},zo=(r,e=Js)=>{Te[e]=Bo(Te[e]||Uo,r),cr.forEach(([s,n])=>{s===e&&n(Te[e])})},Ho=r=>Object.keys(Te).forEach(e=>zo(r,e)),cc=r=>Object.keys(Te).find(e=>Te[e].toasts.some(s=>s.id===r)),Rr=(r=Js)=>e=>{zo(e,r)},dc={blank:4e3,error:4e3,success:2e3,loading:1/0,custom:4e3},uc=(r={},e=Js)=>{let[s,n]=p.useState(Te[e]||Uo),o=p.useRef(Te[e]);p.useEffect(()=>(o.current!==Te[e]&&n(Te[e]),cr.push([e,n]),()=>{let a=cr.findIndex(([l])=>l===e);a>-1&&cr.splice(a,1)}),[e]);let i=s.toasts.map(a=>{var l,c,d;return{...r,...r[a.type],...a,removeDelay:a.removeDelay||((l=r[a.type])==null?void 0:l.removeDelay)||(r==null?void 0:r.removeDelay),duration:a.duration||((c=r[a.type])==null?void 0:c.duration)||(r==null?void 0:r.duration)||dc[a.type],style:{...r.style,...(d=r[a.type])==null?void 0:d.style,...a.style}}});return{...s,toasts:i}},mc=(r,e="blank",s)=>({createdAt:Date.now(),visible:!0,dismissed:!1,type:e,ariaProps:{role:"status","aria-live":"polite"},message:r,pauseDuration:0,...s,id:(s==null?void 0:s.id)||ac()}),Gt=r=>(e,s)=>{let n=mc(e,r,s);return Rr(n.toasterId||cc(n.id))({type:2,toast:n}),n.id},K=(r,e)=>Gt("blank")(r,e);K.error=Gt("error");K.success=Gt("success");K.loading=Gt("loading");K.custom=Gt("custom");K.dismiss=(r,e)=>{let s={type:3,toastId:r};e?Rr(e)(s):Ho(s)};K.dismissAll=r=>K.dismiss(void 0,r);K.remove=(r,e)=>{let s={type:4,toastId:r};e?Rr(e)(s):Ho(s)};K.removeAll=r=>K.remove(void 0,r);K.promise=(r,e,s)=>{let n=K.loading(e.loading,{...s,...s==null?void 0:s.loading});return typeof r=="function"&&(r=r()),r.then(o=>{let i=e.success?jr(e.success,o):void 0;return i?K.success(i,{id:n,...s,...s==null?void 0:s.success}):K.dismiss(n),o}).catch(o=>{let i=e.error?jr(e.error,o):void 0;i?K.error(i,{id:n,...s,...s==null?void 0:s.error}):K.dismiss(n)}),r};var pc=1e3,hc=(r,e="default")=>{let{toasts:s,pausedAt:n}=uc(r,e),o=p.useRef(new Map).current,i=p.useCallback((u,g=pc)=>{if(o.has(u))return;let b=setTimeout(()=>{o.delete(u),a({type:4,toastId:u})},g);o.set(u,b)},[]);p.useEffect(()=>{if(n)return;let u=Date.now(),g=s.map(b=>{if(b.duration===1/0)return;let f=(b.duration||0)+b.pauseDuration-(u-b.createdAt);if(f<0){b.visible&&K.dismiss(b.id);return}return setTimeout(()=>K.dismiss(b.id,e),f)});return()=>{g.forEach(b=>b&&clearTimeout(b))}},[s,n,e]);let a=p.useCallback(Rr(e),[e]),l=p.useCallback(()=>{a({type:5,time:Date.now()})},[a]),c=p.useCallback((u,g)=>{a({type:1,toast:{id:u,height:g}})},[a]),d=p.useCallback(()=>{n&&a({type:6,time:Date.now()})},[n,a]),m=p.useCallback((u,g)=>{let{reverseOrder:b=!1,gutter:f=8,defaultPosition:j}=g||{},h=s.filter(v=>(v.position||j)===(u.position||j)&&v.height),k=h.findIndex(v=>v.id===u.id),N=h.filter((v,y)=>y<k&&v.visible).length;return h.filter(v=>v.visible).slice(...b?[N+1]:[0,N]).reduce((v,y)=>v+(y.height||0)+f,0)},[s]);return p.useEffect(()=>{s.forEach(u=>{if(u.dismissed)i(u.id,u.removeDelay);else{let g=o.get(u.id);g&&(clearTimeout(g),o.delete(u.id))}})},[s,i]),{toasts:s,handlers:{updateHeight:c,startPause:l,endPause:d,calculateOffset:m}}},fc=Me`
from {
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class dd{constructor(e,s,n,o,i,a,l,c,d,m,u,g=!0){this.url_=e,this.method_=s,this.headers_=n,this.body_=o,this.successCodes_=i,this.additionalRetryCodes_=a,this.callback_=l,this.errorCallback_=c,this.timeout_=d,this.progressCallback_=m,this.connectionFactory_=u,this.retry=g,this.pendingConnection_=null,this.backoffId_=null,this.canceled_=!1,this.appDelete_=!1,this.promise_=new Promise((b,f)=>{this.resolve_=b,this.reject_=f,this.start_()})}start_(){const e=(n,o)=>{if(o){n(!1,new Qt(!1,null,!0));return}const i=this.connectionFactory_();this.pendingConnection_=i;const a=l=>{const c=l.loaded,d=l.lengthComputable?l.total:-1;this.progressCallback_!==null&&this.progressCallback_(c,d)};this.progressCallback_!==null&&i.addUploadProgressListener(a),i.send(this.url_,this.method_,this.body_,this.headers_).then(()=>{this.progressCallback_!==null&&i.removeUploadProgressListener(a),this.pendingConnection_=null;const l=i.getErrorCode()===st.NO_ERROR,c=i.getStatus();if(!l||cd(c,this.additionalRetryCodes_)&&this.retry){const m=i.getErrorCode()===st.ABORT;n(!1,new Qt(!1,null,m));return}const d=this.successCodes_.indexOf(c)!==-1;n(!0,new Qt(d,i))})},s=(n,o)=>{const i=this.resolve_,a=this.reject_,l=o.connection;if(o.wasSuccessCode)try{const c=this.callback_(l,l.getResponse());ad(c)?i(c):i()}catch(c){a(c)}else if(l!==null){const c=Ks();c.serverResponse=l.getErrorText(),this.errorCallback_?a(this.errorCallback_(l,c)):a(c)}else if(o.canceled){const c=this.appDelete_?Vo():Yc();a(c)}else{const c=Kc();a(c)}};this.canceled_?s(!1,new Qt(!1,null,!0)):this.backoffId_=od(e,s,this.timeout_)}getPromise(){return this.promise_}cancel(e){this.canceled_=!0,this.appDelete_=e||!1,this.backoffId_!==null&&id(this.backoffId_),this.pendingConnection_!==null&&this.pendingConnection_.abort()}}class Qt{constructor(e,s,n){this.wasSuccessCode=e,this.connection=s,this.canceled=!!n}}function ud(r,e){e!==null&&e.length>0&&(r.Authorization="Firebase "+e)}function md(r,e){r["X-Firebase-Storage-Version"]="webjs/"+(e??"AppManager")}function pd(r,e){e&&(r["X-Firebase-GMPID"]=e)}function hd(r,e){e!==null&&(r["X-Firebase-AppCheck"]=e)}function fd(r,e,s,n,o,i,a=!0){const l=Jo(r.urlParams),c=r.url+l,d=Object.assign({},r.headers);return pd(d,e),ud(d,s),md(d,i),hd(d,n),new dd(c,r.method,d,r.body,r.successCodes,r.additionalRetryCodes,r.handler,r.errorHandler,r.timeout,r.progressCallback,o,a)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Td(r,e){return e}class ce{constructor(e,s,n,o){this.server=e,this.local=s||e,this.writable=!!n,this.xform=o||Td}}let Zt=null;function Dd(r){return!Ys(r)||r.length<2?r:Zo(r)}function ei(){if(Zt)return Zt;const r=[];r.push(new ce("bucket")),r.push(new ce("generation")),r.push(new ce("metageneration")),r.push(new ce("name","fullPath",!0));function e(i,a){return Dd(a)}const s=new ce("name");s.xform=e,r.push(s);function n(i,a){return a!==void 0?Number(a):a}const o=new ce("size");return o.xform=n,r.push(o),r.push(new ce("timeCreated")),r.push(new ce("updated")),r.push(new ce("md5Hash",null,!0)),r.push(new ce("cacheControl",null,!0)),r.push(new ce("contentDisposition",null,!0)),r.push(new ce("contentEncoding",null,!0)),r.push(new ce("contentLanguage",null,!0)),r.push(new ce("contentType",null,!0)),r.push(new ce("metadata","customMetadata",!0)),Zt=r,Zt}function Ed(r,e){function s(){const n=r.bucket,o=r.fullPath,i=new xe(n,o);return e._makeStorageReference(i)}Object.defineProperty(r,"ref",{get:s})}function Ad(r,e,s){const n={};n.type="file";const o=s.length;for(let i=0;i<o;i++){const a=s[i];n[a.local]=a.xform(n,e[a.server])}return Ed(n,r),n}function ti(r,e,s){const n=Qo(e);return n===null?null:Ad(r,n,s)}function Pd(r,e,s,n){const o=Qo(e);if(o===null||!Ys(o.downloadTokens))return null;const i=o.downloadTokens;if(i.length===0)return null;const a=encodeURIComponent;return i.split(",").map(d=>{const m=r.bucket,u=r.fullPath,g="/b/"+a(m)+"/o/"+a(u),b=Qs(g,s,n),f=Jo({alt:"media",token:d});return b+f})[0]}function Rd(r,e){const s={},n=e.length;for(let o=0;o<n;o++){const i=e[o];i.writable&&(s[i.server]=r[i.local])}return JSON.stringify(s)}class ri{constructor(e,s,n,o){this.url=e,this.method=s,this.handler=n,this.timeout=o,this.urlParams={},this.headers={},this.body=null,this.errorHandler=null,this.progressCallback=null,this.successCodes=[200],this.additionalRetryCodes=[]}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function si(r){if(!r)throw Ks()}function Od(r,e){function s(n,o){const i=ti(r,o,e);return si(i!==null),i}return s}function Id(r,e){function s(n,o){const i=ti(r,o,e);return si(i!==null),Pd(i,o,r.host,r._protocol)}return s}function ni(r){function e(s,n){let o;return s.getStatus()===401?s.getErrorText().includes("Firebase App Check token is invalid")?o=Vc():o=Wc():s.getStatus()===402?o=qc(r.bucket):s.getStatus()===403?o=Jc(r.path):o=n,o.status=s.getStatus(),o.serverResponse=n.serverResponse,o}return e}function Md(r){const e=ni(r);function s(n,o){let i=e(n,o);return n.getStatus()===404&&(i=Gc(r.path)),i.serverResponse=o.serverResponse,i}return s}function Ld(r,e,s){const n=e.fullServerUrl(),o=Qs(n,r.host,r._protocol),i="GET",a=r.maxOperationRetryTime,l=new ri(o,i,Id(r,s),a);return l.errorHandler=Md(e),l}function Fd(r,e){return r&&r.contentType||e&&e.type()||"application/octet-stream"}function _d(r,e,s){const n=Object.assign({},s);return n.fullPath=r.path,n.size=e.size(),n.contentType||(n.contentType=Fd(null,e)),n}function $d(r,e,s,n,o){const i=e.bucketOnlyServerUrl(),a={"X-Goog-Upload-Protocol":"multipart"};function l(){let v="";for(let y=0;y<2;y++)v=v+Math.random().toString().slice(2);return v}const c=l();a["Content-Type"]="multipart/related; boundary="+c;const d=_d(e,n,o),m=Rd(d,s),u="--"+c+`\r
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class at{constructor(e,s){this._service=e,s instanceof xe?this._location=s:this._location=xe.makeFromUrl(s,e.host)}toString(){return"gs://"+this._location.bucket+"/"+this._location.path}_newRef(e,s){return new at(e,s)}get root(){const e=new xe(this._location.bucket,"");return this._newRef(this._service,e)}get bucket(){return this._location.bucket}get fullPath(){return this._location.path}get name(){return Zo(this._location.path)}get storage(){return this._service}get parent(){const e=Cd(this._location.path);if(e===null)return null;const s=new xe(this._location.bucket,e);return new at(this._service,s)}_throwIfRoot(e){if(this._location.path==="")throw sd(e)}}function zd(r,e,s){r._throwIfRoot("uploadBytes");const n=$d(r.storage,r._location,ei(),new _e(e,!0),s);return r.storage.makeRequestWithTokens(n,oi).then(o=>({metadata:o,ref:r}))}function Hd(r){r._throwIfRoot("getDownloadURL");const e=Ld(r.storage,r._location,ei());return r.storage.makeRequestWithTokens(e,oi).then(s=>{if(s===null)throw td();return s})}function Gd(r,e){const s=kd(r._location.path,e),n=new xe(r._location.bucket,s);return new at(r.storage,n)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");

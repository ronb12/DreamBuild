...
Generate practical, working applications that users can immediately use.`}parseAIResponse(t,e){try{const a=t.match(/\{[\s\S]*\}/);if(a){const s=JSON.parse(a[0]);if(s.files)return s.files}return this.createFallbackResponse(e,{})}catch(a){return console.error("❌ Failed to parse AI response:",a),this.createFallbackResponse(e,{})}}isGeneralQuestion(t){const e=t.toLowerCase(),a=["what is","what are","what was","what will","what does","what do","how is","how are","how was","how will","how does","how do","when is","when are","when was","when will","when does","when do","where is","where are","where was","where will","where does","where do","why is","why are","why was","why will","why does","why do","who is","who are","who was","who will","who does","who do","weather","temperature","forecast","climate","rain","sunny","cloudy","news","current events","today","recent","latest","breaking","cook","recipe","food","ingredients","cooking","bake","fry","boil","travel","vacation","destination","hotel","flight","trip","visit","health","medicine","exercise","fitness","doctor","hospital","sick","education","learn","study","school","university","college","course","science","research","study","theory","experiment","discovery","history","historical","past","ancient","century","war","battle","business","finance","economy","market","stock","investment","money","sports","game","team","player","football","basketball","soccer","entertainment","movie","music","book","film","song","album","explain","tell me about","describe","define","meaning","definition","help me understand","can you explain","what does it mean","how does it work","is it","are you","do you","can you","will you","would you","should i","could i","would i","might i","may i"],s=["build","create","make","develop","generate","code","app","application","website","web app","mobile app","component","function","class","module","library","api","database","server","backend","frontend","react","vue","angular","node","python","javascript","html","css","js","ts","jsx","tsx","todo","calculator","dashboard","portfolio","blog","ecommerce","shop","store","landing page"],r=a.some(i=>e.includes(i));return s.some(i=>e.includes(i))?!1:!!(r||e.startsWith("what")||e.startsWith("how")||e.startsWith("when")||e.startsWith("where")||e.startsWith("why")||e.startsWith("who")||e.startsWith("is")||e.startsWith("are")||e.startsWith("do")||e.startsWith("does")||e.startsWith("can")||e.startsWith("will")||e.startsWith("would")||e.startsWith("should")||e.startsWith("could")||e.startsWith("explain")||e.startsWith("tell")||e.startsWith("describe")||e.startsWith("define")||e.endsWith("?")||e.includes("?")&&(e.includes("what")||e.includes("how")||e.includes("when")||e.includes("where")||e.includes("why")||e.includes("who")||e.includes("is")||e.includes("are")||e.includes("do")||e.includes("does")||e.includes("can")||e.includes("will")||e.includes("would")||e.includes("should")||e.includes("could")||e.includes("explain")||e.includes("tell")||e.includes("describe")||e.includes("define")))}createConversationalResponse(t,e={}){const a=t.toLowerCase();return a.includes("weather")||a.includes("temperature")||a.includes("forecast")?{type:"conversational_response",message:"I'd be happy to help with weather information for your location. However, I don't have access to real-time weather data. For current weather conditions, I recommend checking a reliable weather service like Weather.com, AccuWeather, or your local weather app.",summary:"Weather information request",details:["Weather data requires real-time access to meteorological services","Recommended sources: Weather.com, AccuWeather, local weather apps","For accurate forecasts, use official weather services"],sources:["Weather.com","AccuWeather","National Weather Service"],prompt:t,generatedAt:new Date().toISOString(),context:e}:a.includes("cook")||a.includes("recipe")||a.includes("food")?{type:"conversational_response",message:"I can help with cooking questions! For recipes and cooking techniques, I recommend checking reliable cooking websites like AllRecipes.com, Food Network, or Serious Eats. These sources provide tested recipes and expert cooking advice.",summary:"Cooking and recipe information",details:["Cooking requires specific recipes and techniques","Recommended sources: AllRecipes.com, Food Network, Serious Eats","Always follow food safety guidelines when cooking"],sources:["AllRecipes.com","Food Network","Serious Eats"],prompt:t,generatedAt:new Date().toISOString(),context:e}:a.includes("capital")||a.includes("country")||a.includes("city")?{type:"conversational_response",message:"I can help with geography questions! For accurate and up-to-date geographical information, I recommend checking reliable sources like National Geographic, World Atlas, or official government websites.",summary:"Geography information",details:["Geographical information changes over time","Recommended sources: National Geographic, World Atlas, government sites","For current data, check official sources"],sources:["National Geographic","World Atlas","Government websites"],prompt:t,generatedAt:new Date().toISOString(),context:e}:{type:"conversational_response",message:`I understand you're asking about "${t}". While I'm primarily designed for code generation and development tasks, I can provide general information when I have access to current data. For the most accurate and up-to-date information, I recommend checking reliable sources or using a general-purpose AI assistant.`,summary:"General information request",details:["This appears to be a general knowledge question","For current information, check reliable sources","I can help with code generation and development tasks"],sources:["Wikipedia","Reliable news sources","Official websites"],prompt:t,generatedAt:new Date().toISOString(),context:e}}createFallbackResponse(t,e={}){return console.log("🔄 Creating fallback response for prompt:",t),this.isGeneralQuestion(t)?(console.log("❓ General question detected, providing conversational response..."),this.createConversationalResponse(t,e)):{files:this.generateFallbackCode(t,e),message:`I've generated a ${this.extractAppType(t)} application based on your request. This is a working template that you can customize further.`,prompt:t,generatedAt:new Date().toISOString(),context:e}}generateFallbackCode(t,e={}){const a=t.toLowerCase();return a.includes("dashboard")||a.includes("analytics")?this.generateTemplateById("react-dashboard",e):a.includes("todo")||a.includes("task")?this.generateTemplateById("todo-app",e):a.includes("ecommerce")||a.includes("store")||a.includes("shop")?this.generateTemplateById("ecommerce-store",e):{"index.html":`<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">

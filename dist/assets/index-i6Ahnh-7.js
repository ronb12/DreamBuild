 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ye{constructor(e,s){this.bucket=e,this.path_=s}get path(){return this.path_}get isRoot(){return this.path.length===0}fullServerUrl(){const e=encodeURIComponent;return"/b/"+e(this.bucket)+"/o/"+e(this.path)}bucketOnlyServerUrl(){return"/b/"+encodeURIComponent(this.bucket)+"/o"}static makeFromBucketSpec(e,s){let n;try{n=ye.makeFromUrl(e,s)}catch{return new ye(e,"")}if(n.path==="")return n;throw dd(e)}static makeFromUrl(e,s){let n=null;const o="([A-Za-z0-9.\\-_]+)";function i(w){w.path.charAt(w.path.length-1)==="/"&&(w.path_=w.path_.slice(0,-1))}const a="(/(.*))?$",l=new RegExp("^gs://"+o+a,"i"),d={bucket:1,path:3};function c(w){w.path_=decodeURIComponent(w.path)}const u="v[A-Za-z0-9_]+",m=s.replace(/[.]/g,"\\."),b="(/([^?#]*).*)?$",v=new RegExp(`^https?://${m}/${u}/b/${o}/o${b}`,"i"),g={bucket:1,path:3},f=s===Ko?"(?:storage.googleapis.com|storage.cloud.google.com)":s,h="([^?#]*)",S=new RegExp(`^https?://${f}/${o}/${h}`,"i"),j=[{regex:l,indices:d,postModify:i},{regex:v,indices:g,postModify:c},{regex:S,indices:{bucket:1,path:2},postModify:c}];for(let w=0;w<j.length;w++){const y=j[w],D=y.regex.exec(e);if(D){const A=D[y.indices.bucket];let M=D[y.indices.path];M||(M=""),n=new ye(A,M),y.postModify(n);break}}if(n==null)throw cd(e);return n}}class gd{constructor(e){this.promise_=Promise.reject(e)}getPromise(){return this.promise_}cancel(e=!1){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function xd(r,e,s){let n=1,o=null,i=null,a=!1,l=0;function d(){return l===2}let c=!1;function u(...h){c||(c=!0,e.apply(null,h))}function m(h){o=setTimeout(()=>{o=null,r(v,d())},h)}function b(){i&&clearTimeout(i)}function v(h,...S){if(c){b();return}if(h){b(),u.call(null,h,...S);return}if(d()||a){b(),u.call(null,h,...S);return}n<64&&(n*=2);let j;l===1?(l=2,j=0):j=(n+Math.random())*1e3,m(j)}let g=!1;function f(h){g||(g=!0,b(),!c&&(o!==null?(h||(l=2),clearTimeout(o),m(0)):h||(l=1)))}return m(0),i=setTimeout(()=>{a=!0,f(!0)},s),f}function bd(r){r(!1)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
</html>`,console.log("🎮 Preview Debug - Created basic HTML structure")}let R=x;if(w.trim()&&(R=R.replace(/<link[^>]*rel=["']stylesheet["'][^>]*href=["']style\.css["'][^>]*>/gi,`<style>${w}</style>`),R===x&&R.includes("<head>")?R=R.replace("<head>",`<head>
<style>${w}</style>`):R===x&&!R.includes("<head>")&&(R.includes("<title>")?R=R.replace("</title>",`</title>
<style>${w}</style>`):R=`<style>${w}</style>
${R}`)),y.trim()){const $=`(function() {
          ${y}
...
${R}`),console.log("🎮 Preview Debug - Final HTML length:",R.length),console.log("🎮 Preview Debug - HTML contains <style>:",R.includes("<style>")),console.log("🎮 Preview Debug - HTML contains <script>:",R.includes("<script>")),console.log("🎮 Preview Debug - HTML preview:",R.substring(0,500)+"...");const k=e.current;k.srcdoc=R,k.onload=()=>{n(!1),l(null)},k.onerror=()=>{n(!1),l("Failed to load preview")}}catch(x){console.error("Preview update error:",x),n(!1),l("Preview update failed")}},m=x=>x?x.replace(/`/g,"\\`").replace(/\${/g,"\\${").replace(/\$/g,"\\$"):"",b=()=>{if(console.log("🎮 Creating React preview..."),!e.current){console.log("🎮 createReactPreview: iframeRef.current is null");return}try{const x=r.files["src/components/GameApp.jsx"]||"",j=r.files["src/components/GameComponent.jsx"]||"",w=r.files["src/components/TempleRunUI.jsx"]||"",y=r.files["src/components/RunnerPlayer.jsx"]||"",D=r.files["src/components/Obstacle.jsx"]||"",A=r.files["src/components/Coin.jsx"]||"",M=r.files["src/components/Player.jsx"]||"",B=r.files["src/components/GameApp.css"]||"",E=r.files["src/components/GameComponent.css"]||"",R=r.files["src/components/TempleRunUI.css"]||"",k=r.files["src/components/RunnerPlayer.css"]||"",$=r.files["src/components/Obstacle.css"]||"",T=r.files["src/components/Coin.css"]||"",P=r.files["src/components/Player.css"]||"",L=w||y||D,q=M||A,G=j.toLowerCase(),ce=G.includes("temple run")||G.includes("lane")||G.includes("jump")||G.includes("slide")||G.includes("obstacle")||G.includes("endless runner"),ge=L||ce,U=q&&!ge;console.log("🎮 Preview Debug - Available files:"),console.log("🎮 - templeRunUIFile:",!!w),console.log("🎮 - runnerPlayerFile:",!!y),console.log("🎮 - obstacleFile:",!!D),console.log("🎮 - playerFile:",!!M),console.log("🎮 - coinFile:",!!A),console.log("🎮 - hasTempleRunFiles:",L),console.log("🎮 - hasTempleRunContent:",ce),console.log("🎮 - isTempleRun:",ge),console.log("🎮 - isCoinCollector:",U),console.log("🎮 - All project files:",Object.keys(r.files)),console.log("🎮 FINAL GAME TYPE DECISION:"),console.log(ge?"🎮 ✅ RENDERING TEMPLE RUN GAME":U?"🎮 ✅ RENDERING COIN COLLECTOR GAME":"🎮 ✅ RENDERING DEFAULT GAME");const W=`
      <!DOCTYPE html>
      <html lang="en">
      <head>
        <meta charset="UTF-8">
...
`,A=()=>{const T={components:n,appCode:x(),cssCode:D(),metadata:{projectId:r,exportedAt:new Date().toISOString(),componentCount:n.length}},P=JSON.stringify(T,null,2),L=new Blob([P],{type:"application/json"}),q=URL.createObjectURL(L),G=document.createElement("a");G.href=q,G.download=`dreambuild-project-${r}.json`,G.click(),URL.revokeObjectURL(q)};return p.useEffect(()=>{e&&e({appCode:x(),cssCode:D(),components:n})},[n,e]),t.jsx(wf,{backend:pg,children:t.jsxs("div",{className:"visual-editor",children:[t.jsxs("div",{className:"editor-header",children:[t.jsx("h2",{children:"🎨 Visual Editor"}),t.jsxs("div",{className:"editor-controls",children:[t.jsx("button",{className:"btn btn-secondary",onClick:()=>u(!c),children:c?"Edit":"Preview"}),t.jsx("button",{className:"btn btn-primary",onClick:A,children:"Export"})]})]}),t.jsxs("div",{className:"editor-layout",children:[t.jsxs("div",{className:"component-library",children:[t.jsx("h3",{children:"📚 Component Library"}),t.jsx("div",{className:"library-categories",children:["Layout","Content","Interactive","Form","Media","Data","Navigation","Overlay"].map(T=>t.jsxs("div",{className:"category",children:[t.jsx("h4",{children:T}),t.jsx("div",{className:"category-components",children:h.filter(P=>P.category===T).map(P=>t.jsx(fg,{type:P.type,name:P.name,icon:P.icon},P.type))})]},T))})]}),t.jsxs("div",{className:"canvas-container",children:[t.jsxs("div",{className:"canvas-toolbar",children:[t.jsxs("div",{className:"canvas-controls",children:[t.jsx("button",{className:"btn btn-sm",onClick:()=>g(v*.8),children:"Zoom Out"}),t.jsxs("span",{className:"zoom-level",children:[Math.round(v*100),"%"]}),t.jsx("button",{className:"btn btn-sm",onClick:()=>g(v*1.2),children:"Zoom In"})]}),t.jsx("div",{className:"canvas-size",children:t.jsxs("select",{value:`${m.width}x${m.height}`,onChange:T=>{const[P,L]=T.target.value.split("x").map(Number);b({width:P,height:L})},children:[t.jsx("option",{value:"1200x800",children:"Desktop (1200x800)"}),t.jsx("option",{value:"768x1024",children:"Tablet (768x1024)"}),t.jsx("option",{value:"375x667",children:"Mobile (375x667)"})]})})]}),t.jsx("div",{className:"canvas",ref:f,style:{width:m.width*v,height:m.height*v,transform:`scale(${v})`,transformOrigin:"top left"},children:t.jsx(gg,{onDrop:j,children:n.map(T=>t.jsx(xg,{component:T,onSelect:w,isSelected:(i==null?void 0:i.id)===T.id},T.id))})})]}),l&&i&&t.jsxs("div",{className:"properties-panel",children:[t.jsx("h3",{children:"⚙️ Properties"}),t.jsxs("div",{className:"property-groups",children:[t.jsxs("div",{className:"property-group",children:[t.jsx("h4",{children:"Content"}),t.jsxs("div",{className:"property",children:[t.jsx("label",{children:"Text Content"}),t.jsx("input",{type:"text",value:i.content||"",onChange:T=>y("content",T.target.value)})]})]}),t.jsxs("div",{className:"property-group",children:[t.jsx("h4",{children:"Position"}),t.jsxs("div",{className:"property",children:[t.jsx("label",{children:"X Position"}),t.jsx("input",{type:"number",value:((M=i.position)==null?void 0:M.x)||0,onChange:T=>y("left",`${T.target.value}px`)})]}),t.jsxs("div",{className:"property",children:[t.jsx("label",{children:"Y Position"}),t.jsx("input",{type:"number",value:((B=i.position)==null?void 0:B.y)||0,onChange:T=>y("top",`${T.target.value}px`)})]})]}),t.jsxs("div",{className:"property-group",children:[t.jsx("h4",{children:"Size"}),t.jsxs("div",{className:"property",children:[t.jsx("label",{children:"Width"}),t.jsx("input",{type:"number",value:((E=i.size)==null?void 0:E.width)||200,onChange:T=>y("width",`${T.target.value}px`)})]}),t.jsxs("div",{className:"property",children:[t.jsx("label",{children:"Height"}),t.jsx("input",{type:"number",value:((R=i.size)==null?void 0:R.height)||100,onChange:T=>y("height",`${T.target.value}px`)})]})]}),t.jsxs("div",{className:"property-group",children:[t.jsx("h4",{children:"Style"}),t.jsxs("div",{className:"property",children:[t.jsx("label",{children:"Background Color"}),t.jsx("input",{type:"color",value:((k=i.styles)==null?void 0:k.backgroundColor)||"#ffffff",onChange:T=>y("backgroundColor",T.target.value)})]}),t.jsxs("div",{className:"property",children:[t.jsx("label",{children:"Border Color"}),t.jsx("input",{type:"color",value:(($=i.styles)==null?void 0:$.borderColor)||"#dddddd",onChange:T=>y("borderColor",T.target.value)})]})]})]})]})]}),t.jsx("style",{jsx:!0,children:`
          .visual-editor {
            height: 100vh;
            display: flex;
            flex-direction: column;

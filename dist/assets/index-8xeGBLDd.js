import{r as p,a as da,b as ua,R as De,g as ma}from"./react-vendor-DWvC8KHc.js";import{_ as pa,C as ha,r as pn,S as fa,F as ga,g as fs,a as Tr,b as xa,c as ba,d as ya,i as vr,e as $s,f as Bs,o as Us,h as dr,j as V,s as va,G as wa,k as hn,l as be,m as ja,n as Na,u as er,p as Rt,q as ue,t as we,w as me,v as Ot,x as $e,y as Yr,z as ur,A as Sa,B as It}from"./firebase-_l3dWQPc.js";import{_ as rt}from"./monaco-editor-BWpThiUx.js";import{S as yt,R as Ee,C as X,D as bt,U as gs,M as Ca,a as ka,b as xs,L as fn,X as Ta,c as Da,G as pe,T as Hs,d as wr,e as zs,m as O,f as bo,Z as vt,F as Fe,P as wt,g as ft,h as yo,i as We,j as Ea,k as vo,A as He,l as zt,n as jt,o as bs,p as wo,q as Dr,E as Gt,r as Aa,s as Pa,B as Xr,t as jr,u as Ra,v as Oa,w as Ie,x as Ve,y as Er,z as Ae,H as Gs,I as Ia,J as it,K as Nt,N as ys,O as Me,Q as jo,V as Ma,W as No,Y as Fa,_ as So,$ as Co,a0 as La,a1 as qs,a2 as _a,a3 as $a,a4 as Ba,a5 as Ar,a6 as gt,a7 as Ua,a8 as ko,a9 as Ha,aa as za,ab as Ga,ac as mr,ad as qa,ae as Qr,af as gn,ag as vs,ah as ws,ai as js,aj as Wa,ak as Va,al as Ja}from"./ui-vendor-6CVz1JuZ.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))n(o);new MutationObserver(o=>{for(const i of o)if(i.type==="childList")for(const a of i.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&n(a)}).observe(document,{childList:!0,subtree:!0});function s(o){const i={};return o.integrity&&(i.integrity=o.integrity),o.referrerPolicy&&(i.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?i.credentials="include":o.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function n(o){if(o.ep)return;o.ep=!0;const i=s(o);fetch(o.href,i)}})();var To={exports:{}},Pr={};/**
 * @license React
 ...
 *
 * @license MIT
 */function Cs(){return Cs=Object.assign?Object.assign.bind():function(r){for(var e=1;e<arguments.length;e++){var s=arguments[e];for(var n in s)Object.prototype.hasOwnProperty.call(s,n)&&(r[n]=s[n])}return r},Cs.apply(this,arguments)}function Vl(r,e){if(r==null)return{};var s={},n=Object.keys(r),o,i;for(i=0;i<n.length;i++)o=n[i],!(e.indexOf(o)>=0)&&(s[o]=r[o]);return s}function Jl(r){return!!(r.metaKey||r.altKey||r.ctrlKey||r.shiftKey)}function Kl(r,e){return r.button===0&&(!e||e==="_self")&&!Jl(r)}const Yl=["onClick","relative","reloadDocument","replace","state","target","to","preventScrollReset","viewTransition"],Xl="6";try{window.__reactRouterVersion=Xl}catch{}const Ql="startTransition",Nn=ua[Ql];function Zl(r){let{basename:e,children:s,future:n,window:o}=r,i=p.useRef();i.current==null&&(i.current=tl({window:o,v5Compat:!0}));let a=i.current,[l,d]=p.useState({action:a.action,location:a.location}),{v7_startTransition:c}=n||{},u=p.useCallback(m=>{c&&Nn?Nn(()=>d(m)):d(m)},[d,c]);return p.useLayoutEffect(()=>a.listen(u),[a,u]),p.useEffect(()=>zl(n),[n]),p.createElement(ql,{basename:e,children:s,location:l.location,navigationType:l.action,navigator:a,future:n})}const ec=typeof window<"u"&&typeof window.document<"u"&&typeof window.document.createElement<"u",tc=/^(?:[a-z][a-z0-9+.-]*:|\/\/)/i,ae=p.forwardRef(function(e,s){let{onClick:n,relative:o,reloadDocument:i,replace:a,state:l,target:d,to:c,preventScrollReset:u,viewTransition:m}=e,b=Vl(e,Yl),{basename:y}=p.useContext(Je),f,g=!1;if(typeof c=="string"&&tc.test(c)&&(f=c,ec))try{let j=new URL(window.location.href),w=c.startsWith("//")?new URL(j.protocol+c):new URL(c),v=Ws(w.pathname,y);w.origin===j.origin&&v!=null?c=v+w.search+w.hash:g=!0}catch{}let h=Dl(c,{relative:o}),S=rc(c,{replace:a,state:l,target:d,preventScrollReset:u,relative:o,viewTransition:m});function x(j){n&&n(j),j.defaultPrevented||S(j)}return p.createElement("a",Cs({},b,{href:f||h,onClick:g||i?n:x,ref:s,target:d}))});var Sn;(function(r){r.UseScrollRestoration="useScrollRestoration",r.UseSubmit="useSubmit",r.UseSubmitFetcher="useSubmitFetcher",r.UseFetcher="useFetcher",r.useViewTransitionState="useViewTransitionState"})(Sn||(Sn={}));var Cn;(function(r){r.UseFetcher="useFetcher",r.UseFetchers="useFetchers",r.UseScrollRestoration="useScrollRestoration"})(Cn||(Cn={}));function rc(r,e){let{target:s,replace:n,state:o,preventScrollReset:i,relative:a,viewTransition:l}=e===void 0?{}:e,d=Or(),c=Ye(),u=Fo(r,{relative:a});return p.useCallback(m=>{if(Kl(m,s)){m.preventDefault();let b=n!==void 0?n:Nr(c)===Nr(u);d(r,{replace:b,state:o,preventScrollReset:i,relative:a,viewTransition:l})}},[c,d,u,n,o,s,r,i,a,l])}let sc={data:""},nc=r=>typeof window=="object"?((r?r.querySelector("#_goober"):window._goober)||Object.assign((r||document.head).appendChild(document.createElement("style")),{innerHTML:" ",id:"_goober"})).firstChild:r||sc,oc=/(?:([\u0080-\uFFFF\w-%@]+) *:? *([^{;]+?);|([^;}{]*?) *{)|(}\s*)/g,ic=/\/\*[^]*?\*\/|  +/g,kn=/\n+/g,Be=(r,e)=>{let s="",n="",o="";for(let i in r){let a=r[i];i[0]=="@"?i[1]=="i"?s=i+" "+a+";":n+=i[1]=="f"?Be(a,i):i+"{"+Be(a,i[1]=="k"?"":e)+"}":typeof a=="object"?n+=Be(a,e?e.replace(/([^,])+/g,l=>i.replace(/([^,]*:\S+\([^)]*\))|([^,])+/g,d=>/&/.test(d)?d.replace(/&/g,l):l?l+" "+d:d)):i):a!=null&&(i=/^--/.test(i)?i:i.replace(/[A-Z]/g,"-$&").toLowerCase(),o+=Be.p?Be.p(i,a):i+":"+a+";")}return s+(e&&o?e+"{"+o+"}":o)+n},Re={},Bo=r=>{if(typeof r=="object"){let e="";for(let s in r)e+=s+Bo(r[s]);return e}return r},ac=(r,e,s,n,o)=>{let i=Bo(r),a=Re[i]||(Re[i]=(d=>{let c=0,u=11;for(;c<d.length;)u=101*u+d.charCodeAt(c++)>>>0;return"go"+u})(i));if(!Re[a]){let d=i!==r?r:(c=>{let u,m,b=[{}];for(;u=oc.exec(c.replace(ic,""));)u[4]?b.shift():u[3]?(m=u[3].replace(kn," ").trim(),b.unshift(b[0][m]=b[0][m]||{})):b[0][u[1]]=u[2].replace(kn," ").trim();return b[0]})(r);Re[a]=Be(o?{["@keyframes "+a]:d}:d,s?"":"."+a)}let l=s&&Re.g?Re.g:null;return s&&(Re.g=Re[a]),((d,c,u,m)=>{m?c.data=c.data.replace(m,d):c.data.indexOf(d)===-1&&(c.data=u?d+c.data:c.data+d)})(Re[a],e,n,l),a},lc=(r,e,s)=>r.reduce((n,o,i)=>{let a=e[i];if(a&&a.call){let l=a(s),d=l&&l.props&&l.props.className||/^go/.test(l)&&l;a=d?"."+d:l&&typeof l=="object"?l.props?"":Be(l,""):l===!1?"":l}return n+o+(a??"")},"");function Ir(r){let e=this||{},s=r.call?r(e.p):r;return ac(s.unshift?s.raw?lc(s,[].slice.call(arguments,1),e.p):s.reduce((n,o)=>Object.assign(n,o&&o.call?o(e.p):o),{}):s,nc(e.target),e.g,e.o,e.k)}let Uo,ks,Ts;Ir.bind({g:1});let Le=Ir.bind({k:1});function cc(r,e,s,n){Be.p=e,Uo=r,ks=s,Ts=n}function Xe(r,e){let s=this||{};return function(){let n=arguments;function o(i,a){let l=Object.assign({},i),d=l.className||o.className;s.p=Object.assign({theme:ks&&ks()},l),s.o=/ *go\d+/.test(d),l.className=Ir.apply(s,n)+(d?" "+d:"");let c=r;return r[0]&&(c=l.as||r,delete l.as),Ts&&c[0]&&Ts(l),Uo(c,l)}return o}}var dc=r=>typeof r=="function",Sr=(r,e)=>dc(r)?r(e):r,uc=(()=>{let r=0;return()=>(++r).toString()})(),Ho=(()=>{let r;return()=>{if(r===void 0&&typeof window<"u"){let e=matchMedia("(prefers-reduced-motion: reduce)");r=!e||e.matches}return r}})(),mc=20,Ys="default",zo=(r,e)=>{let{toastLimit:s}=r.settings;switch(e.type){case 0:return{...r,toasts:[e.toast,...r.toasts].slice(0,s)};case 1:return{...r,toasts:r.toasts.map(a=>a.id===e.toast.id?{...a,...e.toast}:a)};case 2:let{toast:n}=e;return zo(r,{type:r.toasts.find(a=>a.id===n.id)?1:0,toast:n});case 3:let{toastId:o}=e;return{...r,toasts:r.toasts.map(a=>a.id===o||o===void 0?{...a,dismissed:!0,visible:!1}:a)};case 4:return e.toastId===void 0?{...r,toasts:[]}:{...r,toasts:r.toasts.filter(a=>a.id!==e.toastId)};case 5:return{...r,pausedAt:e.time};case 6:let i=e.time-(r.pausedAt||0);return{...r,pausedAt:void 0,toasts:r.toasts.map(a=>({...a,pauseDuration:a.pauseDuration+i}))}}},pr=[],Go={toasts:[],pausedAt:void 0,settings:{toastLimit:mc}},ke={},qo=(r,e=Ys)=>{ke[e]=zo(ke[e]||Go,r),pr.forEach(([s,n])=>{s===e&&n(ke[e])})},Wo=r=>Object.keys(ke).forEach(e=>qo(r,e)),pc=r=>Object.keys(ke).find(e=>ke[e].toasts.some(s=>s.id===r)),Mr=(r=Ys)=>e=>{qo(e,r)},hc={blank:4e3,error:4e3,success:2e3,loading:1/0,custom:4e3},fc=(r={},e=Ys)=>{let[s,n]=p.useState(ke[e]||Go),o=p.useRef(ke[e]);p.useEffect(()=>(o.current!==ke[e]&&n(ke[e]),pr.push([e,n]),()=>{let a=pr.findIndex(([l])=>l===e);a>-1&&pr.splice(a,1)}),[e]);let i=s.toasts.map(a=>{var l,d,c;return{...r,...r[a.type],...a,removeDelay:a.removeDelay||((l=r[a.type])==null?void 0:l.removeDelay)||(r==null?void 0:r.removeDelay),duration:a.duration||((d=r[a.type])==null?void 0:d.duration)||(r==null?void 0:r.duration)||hc[a.type],style:{...r.style,...(c=r[a.type])==null?void 0:c.style,...a.style}}});return{...s,toasts:i}},gc=(r,e="blank",s)=>({createdAt:Date.now(),visible:!0,dismissed:!1,type:e,ariaProps:{role:"status","aria-live":"polite"},message:r,pauseDuration:0,...s,id:(s==null?void 0:s.id)||uc()}),Jt=r=>(e,s)=>{let n=gc(e,r,s);return Mr(n.toasterId||pc(n.id))({type:2,toast:n}),n.id},Y=(r,e)=>Jt("blank")(r,e);Y.error=Jt("error");Y.success=Jt("success");Y.loading=Jt("loading");Y.custom=Jt("custom");Y.dismiss=(r,e)=>{let s={type:3,toastId:r};e?Mr(e)(s):Wo(s)};Y.dismissAll=r=>Y.dismiss(void 0,r);Y.remove=(r,e)=>{let s={type:4,toastId:r};e?Mr(e)(s):Wo(s)};Y.removeAll=r=>Y.remove(void 0,r);Y.promise=(r,e,s)=>{let n=Y.loading(e.loading,{...s,...s==null?void 0:s.loading});return typeof r=="function"&&(r=r()),r.then(o=>{let i=e.success?Sr(e.success,o):void 0;return i?Y.success(i,{id:n,...s,...s==null?void 0:s.success}):Y.dismiss(n),o}).catch(o=>{let i=e.error?Sr(e.error,o):void 0;i?Y.error(i,{id:n,...s,...s==null?void 0:s.error}):Y.dismiss(n)}),r};var xc=1e3,bc=(r,e="default")=>{let{toasts:s,pausedAt:n}=fc(r,e),o=p.useRef(new Map).current,i=p.useCallback((m,b=xc)=>{if(o.has(m))return;let y=setTimeout(()=>{o.delete(m),a({type:4,toastId:m})},b);o.set(m,y)},[]);p.useEffect(()=>{if(n)return;let m=Date.now(),b=s.map(y=>{if(y.duration===1/0)return;let f=(y.duration||0)+y.pauseDuration-(m-y.createdAt);if(f<0){y.visible&&Y.dismiss(y.id);return}return setTimeout(()=>Y.dismiss(y.id,e),f)});return()=>{b.forEach(y=>y&&clearTimeout(y))}},[s,n,e]);let a=p.useCallback(Mr(e),[e]),l=p.useCallback(()=>{a({type:5,time:Date.now()})},[a]),d=p.useCallback((m,b)=>{a({type:1,toast:{id:m,height:b}})},[a]),c=p.useCallback(()=>{n&&a({type:6,time:Date.now()})},[n,a]),u=p.useCallback((m,b)=>{let{reverseOrder:y=!1,gutter:f=8,defaultPosition:g}=b||{},h=s.filter(j=>(j.position||g)===(m.position||g)&&j.height),S=h.findIndex(j=>j.id===m.id),x=h.filter((j,w)=>w<S&&j.visible).length;return h.filter(j=>j.visible).slice(...y?[x+1]:[0,x]).reduce((j,w)=>j+(w.height||0)+f,0)},[s]);return p.useEffect(()=>{s.forEach(m=>{if(m.dismissed)i(m.id,m.removeDelay);else{let b=o.get(m.id);b&&(clearTimeout(b),o.delete(m.id))}})},[s,i]),{toasts:s,handlers:{updateHeight:d,startPause:l,endPause:c,calculateOffset:u}}},yc=Le`
from {
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ye{constructor(e,s){this.bucket=e,this.path_=s}get path(){return this.path_}get isRoot(){return this.path.length===0}fullServerUrl(){const e=encodeURIComponent;return"/b/"+e(this.bucket)+"/o/"+e(this.path)}bucketOnlyServerUrl(){return"/b/"+encodeURIComponent(this.bucket)+"/o"}static makeFromBucketSpec(e,s){let n;try{n=ye.makeFromUrl(e,s)}catch{return new ye(e,"")}if(n.path==="")return n;throw rd(e)}static makeFromUrl(e,s){let n=null;const o="([A-Za-z0-9.\\-_]+)";function i(w){w.path.charAt(w.path.length-1)==="/"&&(w.path_=w.path_.slice(0,-1))}const a="(/(.*))?$",l=new RegExp("^gs://"+o+a,"i"),d={bucket:1,path:3};function c(w){w.path_=decodeURIComponent(w.path)}const u="v[A-Za-z0-9_]+",m=s.replace(/[.]/g,"\\."),b="(/([^?#]*).*)?$",y=new RegExp(`^https?://${m}/${u}/b/${o}/o${b}`,"i"),f={bucket:1,path:3},g=s===Jo?"(?:storage.googleapis.com|storage.cloud.google.com)":s,h="([^?#]*)",S=new RegExp(`^https?://${g}/${o}/${h}`,"i"),j=[{regex:l,indices:d,postModify:i},{regex:y,indices:f,postModify:c},{regex:S,indices:{bucket:1,path:2},postModify:c}];for(let w=0;w<j.length;w++){const v=j[w],D=v.regex.exec(e);if(D){const A=D[v.indices.bucket];let M=D[v.indices.path];M||(M=""),n=new ye(A,M),v.postModify(n);break}}if(n==null)throw td(e);return n}}class ld{constructor(e){this.promise_=Promise.reject(e)}getPromise(){return this.promise_}cancel(e=!1){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function cd(r,e,s){let n=1,o=null,i=null,a=!1,l=0;function d(){return l===2}let c=!1;function u(...h){c||(c=!0,e.apply(null,h))}function m(h){o=setTimeout(()=>{o=null,r(y,d())},h)}function b(){i&&clearTimeout(i)}function y(h,...S){if(c){b();return}if(h){b(),u.call(null,h,...S);return}if(d()||a){b(),u.call(null,h,...S);return}n<64&&(n*=2);let j;l===1?(l=2,j=0):j=(n+Math.random())*1e3,m(j)}let f=!1;function g(h){f||(f=!0,b(),!c&&(o!==null?(h||(l=2),clearTimeout(o),m(0)):h||(l=1)))}return m(0),i=setTimeout(()=>{a=!0,g(!0)},s),g}function dd(r){r(!1)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
